  ...
  public byte[] copy$getConfigData(int groupId, int fileId) {
    ...
    if (rsData != null) {
      ...
      try {
        ...
        System.out.println("Missing overlay hash for " + archiveId + "/" + groupId);
        return rsData;
      }
      ...
      if (!overlayHash.equalsIgnoreCase(originalHash)) {
        System.out.println("Client script " + groupId
    ...
    try {
      ...
      System.out.println("Missing overlay data for " + archiveId + "/" + groupId);
      return rsData;
    }
  }*/
}
