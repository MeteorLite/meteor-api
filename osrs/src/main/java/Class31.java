...
public class Class31 {
  ...
  public static Buffer aClass50_Sub1_Sub2_589 = new Buffer(
      new byte[100]);
  public static char[] aCharArray590 = {' ', 'e', 't', 'a', 'o', 'i', 'h',
  ...
  public static String method320(int i, Buffer class50_sub1_sub2,
      int j) {
    int k = 0;
    int l = -1;
  ...
  public static void method321(String s, int i,
  ...
  public static String method322(byte byte0, String s) {
    aClass50_Sub1_Sub2_589.offset = 0;
    method321(s, 569, aClass50_Sub1_Sub2_589);
    int i = aClass50_Sub1_Sub2_589.offset;
    if (byte0 != 0) {
      for (int j = 1; j > 0; j++) {
      }
    }
