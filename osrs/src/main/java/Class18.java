...
public class Class18 {
	...
	public void method238(int var1, int var2, int var3, int var4) {
		...
		if (var2 >= this.anInt402 && var2 <= this.anInt402) {
		}
	...
	public boolean method240(boolean var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		if (var2 == var4 && var5 == var7) {
			...
			if (var6 == 0) {
				if (var3 == 0) {
					...
					if (var2 == var4 && var7 == var5 + 1 && (this.anIntArrayArray411[var2][var7] & 2621728) == 0) {
						return true;
					}

					if (var2 == var4 && var5 - 1 == var7 && (this.anIntArrayArray411[var2][var7] & 2621698) == 0) {
						return true;
					}
				} else if (var3 == 1) {
					...
					if (var2 == var4 - 1 && var5 == var7 && (this.anIntArrayArray411[var2][var7] & 2621704) == 0) {
						return true;
					}

					if (var2 == var4 + 1 && var5 == var7 && (this.anIntArrayArray411[var2][var7] & 2621824) == 0) {
						return true;
					}
				} else if (var3 == 2) {
					if (var2 == var4 + 1 && var5 == var7) {
			...
			if (var6 == 9) {
				if (var2 == var4 && var7 == var5 + 1 && (this.anIntArrayArray411[var2][var7] & 32) == 0) {
					return true;
				} else if (var2 == var4 && var5 - 1 == var7 && (this.anIntArrayArray411[var2][var7] & 2) == 0) {
					return true;
				} else if (var2 == var4 - 1 && var5 == var7 && (this.anIntArrayArray411[var2][var7] & 8) == 0) {
					return true;
				} else {
					return var2 == var4 + 1 && var5 == var7 && (this.anIntArrayArray411[var2][var7] & 128) == 0;
				}
			} else {
				return false;
			}
	...
	public boolean method242(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
		int var9;
		...
		if (var7 >= var1 && var7 <= var9 && var6 >= var5 && var6 <= var10) {
			return true;
		} else if (var7 == var1 - 1 && var6 >= var5 && var6 <= var10 && (this.anIntArrayArray411[var7 - this.anInt407][var6 - this.anInt408] & 8) == 0 && (var3 & 8) == 0) {
			return true;
		} else if (var9 + 1 == var7 && var6 >= var5 && var6 <= var10 && (this.anIntArrayArray411[var7 - this.anInt407][var6 - this.anInt408] & 128) == 0 && (var3 & 2) == 0) {
			return true;
		} else if (var5 - 1 == var6 && var7 >= var1 && var7 <= var9 && (this.anIntArrayArray411[var7 - this.anInt407][var6 - this.anInt408] & 2) == 0 && (var3 & 4) == 0) {
			return true;
		} else {
			return var10 + 1 == var6 && var7 >= var1 && var7 <= var9 && (this.anIntArrayArray411[var7 - this.anInt407][var6 - this.anInt408] & 32) == 0 && (var3 & 1) == 0;
		}
	}
	...
	public boolean method241(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (var3 == var1 && var2 == var6) {
			...
			if (var4 == 6 || var4 == 7) {
				...
				if (var5 == 0) {
					if (var3 == var1 + 1 && var2 == var6 && (this.anIntArrayArray411[var3][var6] & 128) == 0) {
						return true;
					}
			...
			if (var4 == 8) {
				if (var3 == var1 && var2 + 1 == var6 && (this.anIntArrayArray411[var3][var6] & 32) == 0) {
					return true;
				} else if (var3 == var1 && var2 - 1 == var6 && (this.anIntArrayArray411[var3][var6] & 2) == 0) {
					return true;
				} else if (var3 == var1 - 1 && var2 == var6 && (this.anIntArrayArray411[var3][var6] & 8) == 0) {
					return true;
				} else {
					return var3 == var1 + 1 && var2 == var6 && (this.anIntArrayArray411[var3][var6] & 128) == 0;
				}
			} else {
				return false;
			}
	...
	public void markSolidOccupant(int var1, int var2, int var3, int var4, int var5, boolean var6, int var7) {
		int var8 = 256;
		if (var6) {
			var8 += 131072;
		}
	...
	public void removeCollisionArea(int var1, int var2, int var3, int var4, int var5, boolean var6, int var7) {
		int var8 = 256;
		if (var6) {
			var8 += 131072;
		}
