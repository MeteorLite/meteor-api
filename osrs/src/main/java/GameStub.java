...
public class GameStub extends Applet implements Runnable, MouseListener,
  ...
  public void method1(int i, int j, int k) {
    anInt12 = k;
    anInt13 = j;
    for (aFrame_Sub1_17 = new RSFrame(anInt13, this, anInt12); i >= 0; ) {
      return;
    }
  ...
  public void method2(int i, int j, int k) {
    ...
    if (k != 2) {
      ...
      anInt13 = j;
      aGraphics14 = method11(-756).getGraphics();
      aClass18_15 = new ProducingGraphicsBuffer(anInt13, (byte) -12, method11(-756),
          anInt12);
      method12(this, 1);
    }
  }
  ...
  public void run() {
    ...
    while (anInt6 >= 0) {
      ...
      if (aLongArray9[i] == 0L) {
        ...
        j = (int) ((long) (2560L * anInt7) / (l1 - aLongArray9[i]));
      }
      if (j < 25) {
        j = 25;
      }
      ...
      if (aBoolean11) {
        ...
        System.out.println("fps:" + anInt10 + " ratio:" + j + " count:"
            + i1);
        System.out.println("del:" + k + " deltime:" + anInt7
            + " mindel:" + anInt8);
  ...
  public void method13(int i, boolean flag, String s) {
    ...
    aGraphics14.drawString(s, (anInt12 - fontmetrics.stringWidth(s)) / 2,
        j + 22);
  }
}
