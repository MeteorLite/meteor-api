...
public class Login {
	...
	static final void method1932(PacketBuffer var0, int var1, Player var2, int var3) {
		...
		if ((var3 & 8192) != 0) { // L: 452
			...
			var2.field1169 = var0.readByteNeg(); // L: 455
			var2.field1114 = var0.readByteNeg(); // L: 456
			var2.field1171 = var0.readByteSub(); // L: 457
			var2.field1122 = (byte)var0.readUnsignedByteNeg(); // L: 458
		}

		if ((var3 & 256) != 0) { // L: 460
			var4 = var0.readByteSub(); // L: 461
		}
		...
		if ((var3 & 1) != 0) { // L: 463
			...
			boolean var7 = var0.readUnsignedByteSub() == 1; // L: 466
			var8 = var0.readUnsignedByteSub(); // L: 467
		...
		if ((var3 & 128) != 0) { // L: 507
			var5 = var0.readUnsignedByteSub(); // L: 508
		...
		if ((var3 & 512) != 0) { // L: 515
			var2.field1129 = var0.readByteAdd(); // L: 516
			var2.field1160 = var0.readByte(); // L: 517
			var2.field1132 = var0.readByteSub(); // L: 518
			var2.field1161 = var0.readByteNeg(); // L: 519
		...
		if ((var3 & 8) != 0) { // L: 560
			...
			var14 = var0.readUnsignedByteSub(); // L: 563
		...
		if ((var3 & 16384) != 0) { // L: 566
			...
			var15[var1] = (class193)MusicPatchPcmStream.findEnumerated(var21, var0.readByteNeg()); // L: 573
		}
		...
		if ((var3 & 4) != 0) { // L: 579
			var5 = var0.readUnsignedByteNeg(); // L: 580
			int var16;
			int var19;
			int var20;
			if (var5 > 0) { // L: 581
			...
			if (var14 > 0) { // L: 603
				for (var19 = 0; var19 < var14; ++var19) { // L: 604
					...
					if (var9 != 32767) { // L: 607
						...
						var12 = var9 > 0 ? var0.readUnsignedByteNeg() : var16; // L: 610
