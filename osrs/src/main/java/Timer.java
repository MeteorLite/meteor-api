...
public class Timer {
	...
	public void method6574() {
		this.field4174 = class136.getServerTime(); // L: 19
	} // L: 20
	...
	public void method6562() {
		if (this.field4174 != -1L) { // L: 23
			this.field4175 = class136.getServerTime() - this.field4174; // L: 24
	...
	public void method6563(int var1) {
		this.field4172 = class136.getServerTime(); // L: 30
	...
	public void method6564() {
		if (this.field4172 != -1L) { // L: 35
			this.field4173 = class136.getServerTime() - this.field4172; // L: 36
