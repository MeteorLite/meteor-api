public class Region {
  ...
  public Region(int[][][] is, int i, byte[][][] is_220_, int i_221_,
      int i_222_) {
    anInt150 = 99;
    anInt151 = i_222_;
    anInt152 = i_221_;
  ...
  public static void method165(int i, int i_15_, int i_16_, int i_17_,
      CollisionMap class46, int i_18_, int i_19_, int i_20_, int i_21_,
      Scene class22, int[][][] is) {
    ...
    GameObjectDefinition class47 = GameObjectDefinition.forId(i);
    if (i_20_ == 0) {
      ...
      if (i_16_ == 22) {
        ...
        if (class47.anInt803 == -1 && class47.anIntArray805 == null) {
          class50_sub1_sub4 = class47.method431(22, i_18_, i_22_,
              i_23_, i_24_, i_25_, -1);
        } else {
          class50_sub1_sub4 = new Class50_Sub1_Sub4_Sub5(
              class47.anInt803, i_24_, i_25_, i_23_, 22,
              i, true, i_22_, i_18_);
        }
        class22.method247(i_19_, i_17_, 669, i_28_, i_27_, i_26_,
            i_21_, class50_sub1_sub4);
        ...
        Renderable class50_sub1_sub4;
        if (class47.anInt803 == -1 && class47.anIntArray805 == null) {
          class50_sub1_sub4 = class47.method431(10, i_18_, i_22_,
              i_23_, i_24_, i_25_, -1);
        } else {
          class50_sub1_sub4 = new Class50_Sub1_Sub4_Sub5(
              class47.anInt803, i_24_, i_25_, i_23_, 10,
              i, true, i_22_, i_18_);
        }
        if (class50_sub1_sub4 != null) {
          ...
          class22.method251(i_21_, i_30_, i_17_, class50_sub1_sub4,
              i_28_, i_29_, i_19_, -896, i_31_, i_26_, i_27_);
        }
        ...
        if (class47.anInt803 == -1 && class47.anIntArray805 == null) {
          ...
          class50_sub1_sub4 = new Class50_Sub1_Sub4_Sub5(
              class47.anInt803, i_24_, i_25_, i_23_, i_16_,
              i, true, i_22_, i_18_);
        }
        ...
        Renderable class50_sub1_sub4;
        if (class47.anInt803 == -1 && class47.anIntArray805 == null) {
          class50_sub1_sub4 = class47.method431(0, i_18_, i_22_,
              i_23_, i_24_, i_25_, -1);
        } else {
          class50_sub1_sub4 = new Class50_Sub1_Sub4_Sub5(
              class47.anInt803, i_24_, i_25_, i_23_, 0, i,
              true, i_22_, i_18_);
        }
        ...
        Renderable class50_sub1_sub4;
        if (class47.anInt803 == -1 && class47.anIntArray805 == null) {
          class50_sub1_sub4 = class47.method431(1, i_18_, i_22_,
              i_23_, i_24_, i_25_, -1);
        } else {
          class50_sub1_sub4 = new Class50_Sub1_Sub4_Sub5(
              class47.anInt803, i_24_, i_25_, i_23_, 1, i,
              true, i_22_, i_18_);
        }
        ...
        if (class47.anInt803 == -1 && class47.anIntArray805 == null) {
          class50_sub1_sub4 = class47.method431(2, 4 + i_18_, i_22_,
              i_23_, i_24_, i_25_, -1);
          class50_sub1_sub4_33_ = class47.method431(2, i_32_, i_22_,
              i_23_, i_24_, i_25_, -1);
        } else {
          class50_sub1_sub4 = new Class50_Sub1_Sub4_Sub5(
              class47.anInt803, i_24_, i_25_, i_23_, 2, i,
              true, i_22_, 4 + i_18_);
          class50_sub1_sub4_33_ = new Class50_Sub1_Sub4_Sub5(
              class47.anInt803, i_24_, i_25_, i_23_, 2, i,
              true, i_22_, i_32_);
        }
        class22.method249(i_26_, 49878, anIntArray158[i_32_],
            anIntArray158[i_18_], class50_sub1_sub4_33_, i_19_,
            i_27_, i_28_, i_17_, class50_sub1_sub4, i_21_);
        if (class47.aBoolean810) {
          class46.method412(i_18_, 37679, class47.aBoolean809, i_16_,
              i_19_, i_17_);
        }
        ...
        Renderable class50_sub1_sub4;
        if (class47.anInt803 == -1 && class47.anIntArray805 == null) {
          class50_sub1_sub4 = class47.method431(3, i_18_, i_22_,
              i_23_, i_24_, i_25_, -1);
        } else {
          class50_sub1_sub4 = new Class50_Sub1_Sub4_Sub5(
              class47.anInt803, i_24_, i_25_, i_23_, 3, i,
              true, i_22_, i_18_);
        }
        class22.method249(i_26_, 49878, 0, anIntArray167[i_18_], null,
            i_19_, i_27_, i_28_, i_17_, class50_sub1_sub4, i_21_);
        ...
        if (i_16_ == 4) {
          Renderable class50_sub1_sub4;
          if (class47.anInt803 == -1 && class47.anIntArray805 == null) {
            class50_sub1_sub4 = class47.method431(4, 0, i_22_,
                i_23_, i_24_, i_25_, -1);
          } else {
            class50_sub1_sub4 = new Class50_Sub1_Sub4_Sub5(
                class47.anInt803, i_24_, i_25_, i_23_, 4,
                i, true, i_22_, 0);
          }
          ...
          if (i_38_ > 0) {
            i_37_ = GameObjectDefinition
                .forId(i_38_ >> 14 & 0x7fff).anInt802;
          }
          Renderable class50_sub1_sub4;
          if (class47.anInt803 == -1 && class47.anIntArray805 == null) {
            class50_sub1_sub4 = class47.method431(4, 0, i_22_,
          ...
          class22.method250(i_21_, anIntArray158[i_18_], i_18_ * 512,
              i_27_, i_28_, i_19_, anIntArray143[i_18_] * i_37_,
              i_17_, anIntArray161[i_18_] * i_37_, i_26_,
              class50_sub1_sub4, -930);
        } else if (i_16_ == 6) {
          Renderable class50_sub1_sub4;
          if (class47.anInt803 == -1 && class47.anIntArray805 == null) {
          ...
          class22.method250(i_21_, 256, i_18_, i_27_, i_28_, i_19_,
              0, i_17_, 0, i_26_, class50_sub1_sub4, -930);
        } else if (i_16_ == 7) {
          Renderable class50_sub1_sub4;
          if (class47.anInt803 == -1 && class47.anIntArray805 == null) {
            class50_sub1_sub4 = class47.method431(4, 0, i_22_,
          ...
          class22.method250(i_21_, 512, i_18_, i_27_, i_28_, i_19_,
              0, i_17_, 0, i_26_, class50_sub1_sub4, -930);
        } else if (i_16_ == 8) {
          Renderable class50_sub1_sub4;
          if (class47.anInt803 == -1 && class47.anIntArray805 == null) {
          ...
          class22.method250(i_21_, 768, i_18_, i_27_, i_28_, i_19_,
              0, i_17_, 0, i_26_, class50_sub1_sub4, -930);
        }
      }
    }
  ...
  public static void method169(OnDemandRequester class32_sub1,
  ...
  public static boolean method170(int i, byte i_162_, int i_163_) {
    GameObjectDefinition class47 = GameObjectDefinition.forId(i_163_);
    if (i_162_ != aByte154) {
    ...
    for (; ; ) {
      ...
      for (; ; ) {
        if (bool_263_) {
          ...
          int i_268_ = class50_sub1_sub2.readUByte() >> 2;
          int i_269_ = i_267_ + i;
          int i_270_ = i_266_ + i_258_;
          if (i_269_ > 0 && i_270_ > 0 && i_269_ < 103
              && i_270_ < 103) {
            GameObjectDefinition class47 = GameObjectDefinition
                .forId(i_260_);
  ...
  public void method166(int i, int i_39_, int i_40_, int i_41_) {
    if (i == anInt160) {
      ...
      if (i_41_ > 0) {
        System.arraycopy(anIntArrayArrayArray149[i_39_][
            i_41_ - 1], i_40_ + 1, anIntArrayArrayArray149[i_39_][i_41_], i_40_ + 1, 7);
      }
      if (i_40_ > 0) {
        for (int i_45_ = 1; i_45_ < 8; i_45_++) {
          anIntArrayArrayArray149[i_39_][i_41_ + i_45_][i_40_] = anIntArrayArrayArray149[i_39_][
              i_41_
                  + i_45_][i_40_ - 1];
        }
      }
      if (i_41_ > 0
          && anIntArrayArrayArray149[i_39_][i_41_ - 1][i_40_] != 0) {
        anIntArrayArrayArray149[i_39_][i_41_][i_40_] = anIntArrayArrayArray149[i_39_][i_41_
            - 1][i_40_];
      } else if (i_40_ > 0
          && anIntArrayArrayArray149[i_39_][i_41_][i_40_ - 1] != 0) {
        anIntArrayArrayArray149[i_39_][i_41_][i_40_] = anIntArrayArrayArray149[i_39_][i_41_][i_40_
            - 1];
      } else if (i_41_ > 0
          && i_40_ > 0
          && anIntArrayArrayArray149[i_39_][i_41_ - 1][i_40_ - 1] != 0) {
        anIntArrayArrayArray149[i_39_][i_41_][i_40_] = anIntArrayArrayArray149[i_39_][i_41_ - 1][
            i_40_ - 1];
      }
    }
  }
  ...
  public void method167(CollisionMap[] class46s, int i, Scene class22) {
    ...
    for (int i_50_ = 0; i_50_ < 4; i_50_++) {
      ...
      int i_55_ = -50;
      int i_56_ = (int) Math
          .sqrt(i_53_ * i_53_ + i_54_ * i_54_ + i_55_
              * i_55_);
      ...
      for (int i_58_ = 1; i_58_ < anInt152 - 1; i_58_++) {
        for (int i_59_ = 1; i_59_ < anInt151 - 1; i_59_++) {
          ...
          int i_62_ = (int) Math
              .sqrt(i_60_ * i_60_ + 65536 + i_61_
                  * i_61_);
          int i_63_ = (i_60_ << 8) / i_62_;
          int i_64_ = 65536 / i_62_;
          int i_65_ = (i_61_ << 8) / i_62_;
          int i_66_ = i_51_
              + (i_53_ * i_63_ + i_54_ * i_64_ + i_55_ * i_65_)
              / i_57_;
          int i_67_ = (is[i_59_ - 1][i_58_] >> 2)
              + (is[i_59_ + 1][i_58_] >> 3)
              + (is[i_59_][i_58_ - 1] >> 2)
              + (is[i_59_][i_58_ + 1] >> 3)
              + (is[i_59_][i_58_] >> 1);
      ...
      for (int i_69_ = -5; i_69_ < anInt151 + 5; i_69_++) {
        for (int i_70_ = 0; i_70_ < anInt152; i_70_++) {
          ...
          if (i_71_ >= 0 && i_71_ < anInt151) {
            ...
            if (i_72_ > 0) {
              Floor class15 = Floor.floors[i_72_ - 1];
          ...
          if (i_73_ >= 0 && i_73_ < anInt151) {
            ...
            if (i_74_ > 0) {
              Floor class15 = Floor.floors[i_74_ - 1];
              anIntArray144[i_70_] -= class15.anInt323;
              anIntArray145[i_70_] -= class15.anInt321;
              anIntArray146[i_70_] -= class15.anInt322;
              anIntArray147[i_70_] -= class15.anInt324;
        ...
        if (i_69_ >= 1 && i_69_ < anInt151 - 1) {
          ...
          for (int i_80_ = -5; i_80_ < anInt152 + 5; i_80_++) {
            ...
            if (i_80_ >= 1
                && i_80_ < anInt152 - 1
                && (!aBoolean169
                || (aByteArrayArrayArray138[0][i_69_][i_80_] & 0x2) != 0
                || (aByteArrayArrayArray138[i_50_][i_69_][i_80_] & 0x10) == 0
                && method164(i_80_, i_50_, i_69_,
                (byte) 0) == anInt162)) {
              if (i_50_ < anInt150) {
                anInt150 = i_50_;
              }
              ...
              if (i_83_ > 0 || i_84_ > 0) {
                ...
                if (i_84_ == 0) {
                  ...
                  if (i_101_ >= 0) {
                    ...
                    i_102_ = -2;
                    i_101_ = -1;
                    i_103_ = Canvas.anIntArray1548[method182(
                        class15.anInt325, 96)];
                  } else {
                  ...
                  class22.method246(i_50_, i_69_, i_80_,
                      i_99_, i_100_, i_101_, i_85_,
                      i_86_, i_87_, i_88_,
                      method171(i_93_, i_89_),
                      method171(i_93_, i_90_),
                      method171(i_93_, i_91_),
        ...
        for (int i_113_ = 0; i_113_ <= anInt152; i_113_++) {
          for (int i_114_ = 0; i_114_ <= anInt151; i_114_++) {
            if ((anIntArrayArrayArray168[i_112_][i_114_][i_113_] & i_108_) != 0) {
              ...
              int i_121_ = (i_118_ + 1 - i_117_)
                  * (i_116_ - i_115_ + 1);
              if (i_121_ >= 8) {
                int i_122_ = 240;
                int i_123_ = anIntArrayArrayArray149[i_118_][i_114_][i_115_]
                    - i_122_;
                int i_124_ = anIntArrayArrayArray149[i_117_][i_114_][i_115_];
                Scene.method244(-8967, i_114_ * 128, i_124_,
                    i_114_ * 128, i_116_ * 128 + 128,
            ...
            if ((anIntArrayArrayArray168[i_112_][i_114_][i_113_] & i_109_) != 0) {
              ...
              int i_133_ = (i_130_ + 1 - i_129_)
                  * (i_128_ - i_127_ + 1);
              if (i_133_ >= 8) {
                int i_134_ = 240;
                int i_135_ = anIntArrayArrayArray149[i_130_][i_127_][i_113_]
                    - i_134_;
                int i_136_ = anIntArrayArrayArray149[i_129_][i_127_][i_113_];
                Scene.method244(-8967, i_127_ * 128, i_136_,
                    i_128_ * 128 + 128, i_113_ * 128,
            ...
            if ((anIntArrayArrayArray168[i_112_][i_114_][i_113_] & i_110_) != 0) {
              ...
              if ((i_140_ - i_139_ + 1) * (i_142_ - i_141_ + 1) >= 4) {
                ...
                Scene.method244(-8967, i_139_ * 128, i_145_,
                    i_140_ * 128 + 128, i_142_ * 128 + 128,
  ...
  public void method168(int i, int i_148_, boolean bool, byte[] is,
      int i_149_, int i_150_, int i_151_, CollisionMap[] class46s,
    ...
    for (int i_156_ = 0; i_156_ < 4; i_156_++) {
      for (int i_157_ = 0; i_157_ < 64; i_157_++) {
        for (int i_158_ = 0; i_158_ < 64; i_158_++) {
          if (i_156_ == i_150_ && i_157_ >= i_153_
              && i_157_ < i_153_ + 8 && i_158_ >= i_148_
              && i_158_ < i_148_ + 8) {
            method183(
                0,
                (byte) -61,
                ...
                i,
                i_151_
                    + MapUtils.method348(i, i_157_ & 0x7,
                    i_158_ & 0x7),
                i_149_,
                i_152_
                    + MapUtils.method349(i_158_ & 0x7,
                    i_157_ & 0x7, i));
          } else {
            method183(0, (byte) -61, 0, class50_sub1_sub2, 0, -1,
                0, -1);
          }
        }
      }
  ...
  public void method172(int i, CollisionMap[] class46s, Scene class22,
      boolean bool, byte[] is, int i_166_, int i_167_, int i_168_,
    ...
    if (!bool) {
      ...
      for (; ; ) {
        ...
        for (; ; ) {
          ...
          int i_179_ = class50_sub1_sub2.readUByte();
          int i_180_ = i_179_ >> 2;
          int i_181_ = i_179_ & 0x3;
          if (i_178_ == i_171_ && i_177_ >= i_168_
              && i_177_ < i_168_ + 8 && i_176_ >= i_170_
              && i_176_ < i_170_ + 8) {
            GameObjectDefinition class47 = GameObjectDefinition
                .forId(i_172_);
            int i_182_ = i_169_
                + MapUtils.method350(i_167_, class47.anInt775,
                i_181_, i_177_ & 0x7, class47.anInt801,
                i_176_ & 0x7);
            int i_183_ = i_166_
                + MapUtils.method351(class47.anInt801, i_167_,
  ...
  public void method173(Scene class22, CollisionMap class46, int i,
      int i_185_, int i_186_, byte i_187_, int i_188_, int i_189_,
      int i_190_) {
    if (!aBoolean169 || (aByteArrayArrayArray138[0][i_186_][i] & 0x2) != 0
      ...
      GameObjectDefinition class47 = GameObjectDefinition.forId(i_190_);
      ...
      if (i_189_ == 22) {
        if (!aBoolean169 || class47.aBoolean759 || class47.aBoolean765) {
          Renderable class50_sub1_sub4;
          if (class47.anInt803 == -1 && class47.anIntArray805 == null) {
            class50_sub1_sub4 = class47.method431(22, i_188_,
                i_191_, i_192_, i_193_, i_194_, -1);
          } else {
            class50_sub1_sub4 = new Class50_Sub1_Sub4_Sub5(
                class47.anInt803, i_193_, i_194_, i_192_, 22,
        ...
        Renderable class50_sub1_sub4;
        if (class47.anInt803 == -1 && class47.anIntArray805 == null) {
          class50_sub1_sub4 = class47.method431(10, i_188_, i_191_,
              i_192_, i_193_, i_194_, -1);
        } else {
          class50_sub1_sub4 = new Class50_Sub1_Sub4_Sub5(
              class47.anInt803, i_193_, i_194_, i_192_, 10,
              i_190_, true, i_191_, i_188_);
        }
        if (class50_sub1_sub4 != null) {
          int i_198_ = 0;
          ...
          if (class22.method251(i_185_, i_199_, i, class50_sub1_sub4,
              i_197_, i_198_, i_186_, -896, i_200_, i_195_,
              i_196_)
              && class47.aBoolean807) {
            ...
            if (class50_sub1_sub4 instanceof Model) {
              ...
              class50_sub1_sub4_sub4 = class47.method431(10,
                  i_188_, i_191_, i_192_, i_193_, i_194_, -1);
            }
            if (class50_sub1_sub4_sub4 != null) {
              for (int i_201_ = 0; i_201_ <= i_199_; i_201_++) {
                for (int i_202_ = 0; i_202_ <= i_200_; i_202_++) {
                  ...
                  if (i_203_ > aByteArrayArrayArray164[i_185_][i_186_
                      + i_201_][i + i_202_]) {
                    aByteArrayArrayArray164[i_185_][i_186_
                        + i_201_][i + i_202_] = (byte) i_203_;
                  }
                }
              }
            }
        ...
        if (class47.aBoolean810 && class46 != null) {
          class46.method413(i, i_188_, class47.anInt775,
              class47.anInt801, class47.aBoolean809, i_186_,
              (byte) 52);
        }
      } else if (i_189_ >= 12) {
        Renderable class50_sub1_sub4;
        if (class47.anInt803 == -1 && class47.anIntArray805 == null) {
          class50_sub1_sub4 = class47.method431(i_189_, i_188_,
              i_191_, i_192_, i_193_, i_194_, -1);
        } else {
          class50_sub1_sub4 = new Class50_Sub1_Sub4_Sub5(
              class47.anInt803, i_193_, i_194_, i_192_, i_189_,
              i_190_, true, i_191_, i_188_);
        }
        ...
        Renderable class50_sub1_sub4;
        if (class47.anInt803 == -1 && class47.anIntArray805 == null) {
          class50_sub1_sub4 = class47.method431(0, i_188_, i_191_,
              i_192_, i_193_, i_194_, -1);
        } else {
          class50_sub1_sub4 = new Class50_Sub1_Sub4_Sub5(
              class47.anInt803, i_193_, i_194_, i_192_, 0,
              i_190_, true, i_191_, i_188_);
        }
        class22.method249(i_195_, 49878, 0, anIntArray158[i_188_],
            null, i_186_, i_196_, i_197_, i, class50_sub1_sub4,
            i_185_);
        if (i_188_ == 0) {
        ...
        if (class47.aBoolean810 && class46 != null) {
          class46.method412(i_188_, 37679, class47.aBoolean809,
              i_189_, i_186_, i);
        }
        ...
        Renderable class50_sub1_sub4;
        if (class47.anInt803 == -1 && class47.anIntArray805 == null) {
          class50_sub1_sub4 = class47.method431(1, i_188_, i_191_,
              i_192_, i_193_, i_194_, -1);
        } else {
          class50_sub1_sub4 = new Class50_Sub1_Sub4_Sub5(
              class47.anInt803, i_193_, i_194_, i_192_, 1,
              i_190_, true, i_191_, i_188_);
        }
        class22.method249(i_195_, 49878, 0, anIntArray167[i_188_],
            null, i_186_, i_196_, i_197_, i, class50_sub1_sub4,
            i_185_);
        if (class47.aBoolean807) {
          if (i_188_ == 0) {
        ...
        if (class47.anInt803 == -1 && class47.anIntArray805 == null) {
          class50_sub1_sub4 = class47.method431(2, 4 + i_188_,
              i_191_, i_192_, i_193_, i_194_, -1);
          class50_sub1_sub4_205_ = class47.method431(2, i_204_,
              i_191_, i_192_, i_193_, i_194_, -1);
        } else {
          class50_sub1_sub4 = new Class50_Sub1_Sub4_Sub5(
              class47.anInt803, i_193_, i_194_, i_192_, 2,
              i_190_, true, i_191_, 4 + i_188_);
          class50_sub1_sub4_205_ = new Class50_Sub1_Sub4_Sub5(
              class47.anInt803, i_193_, i_194_, i_192_, 2,
              i_190_, true, i_191_, i_204_);
        }
        class22.method249(i_195_, 49878, anIntArray158[i_204_],
            anIntArray158[i_188_], class50_sub1_sub4_205_, i_186_,
            i_196_, i_197_, i, class50_sub1_sub4, i_185_);
        if (class47.aBoolean797) {
          if (i_188_ == 0) {
            anIntArrayArrayArray168[i_185_][i_186_][i] |= 0x249;
            anIntArrayArrayArray168[i_185_][i_186_][i + 1] |= 0x492;
        ...
        Renderable class50_sub1_sub4;
        if (class47.anInt803 == -1 && class47.anIntArray805 == null) {
          class50_sub1_sub4 = class47.method431(3, i_188_, i_191_,
              i_192_, i_193_, i_194_, -1);
        } else {
          class50_sub1_sub4 = new Class50_Sub1_Sub4_Sub5(
              class47.anInt803, i_193_, i_194_, i_192_, 3,
              i_190_, true, i_191_, i_188_);
        }
        class22.method249(i_195_, 49878, 0, anIntArray167[i_188_],
            null, i_186_, i_196_, i_197_, i, class50_sub1_sub4,
        ...
        if (i_189_ == 4) {
          Renderable class50_sub1_sub4;
          if (class47.anInt803 == -1 && class47.anIntArray805 == null) {
            class50_sub1_sub4 = class47.method431(4, 0, i_191_,
                i_192_, i_193_, i_194_, -1);
          } else {
            class50_sub1_sub4 = new Class50_Sub1_Sub4_Sub5(
                class47.anInt803, i_193_, i_194_, i_192_, 4,
                i_190_, true, i_191_, 0);
          }
          class22.method250(i_185_, anIntArray158[i_188_],
              i_188_ * 512, i_196_, i_197_, i_186_, 0, i, 0,
              i_195_, class50_sub1_sub4, -930);
        } else if (i_189_ == 5) {
          int i_209_ = 16;
          int i_210_ = class22.method267(i_185_, i_186_, i);
          if (i_210_ > 0) {
            i_209_ = GameObjectDefinition
                .forId(i_210_ >> 14 & 0x7fff).anInt802;
          }
          Renderable class50_sub1_sub4;
          if (class47.anInt803 == -1 && class47.anIntArray805 == null) {
            class50_sub1_sub4 = class47.method431(4, 0, i_191_,
          ...
          class22.method250(i_185_, anIntArray158[i_188_],
              i_188_ * 512, i_196_, i_197_, i_186_,
          ...
          class22.method250(i_185_, 256, i_188_, i_196_, i_197_,
              i_186_, 0, i, 0, i_195_, class50_sub1_sub4, -930);
        } else if (i_189_ == 7) {
          Renderable class50_sub1_sub4;
          if (class47.anInt803 == -1 && class47.anIntArray805 == null) {
            class50_sub1_sub4 = class47.method431(4, 0, i_191_,
          ...
          class22.method250(i_185_, 512, i_188_, i_196_, i_197_,
              i_186_, 0, i, 0, i_195_, class50_sub1_sub4, -930);
        } else if (i_189_ == 8) {
          Renderable class50_sub1_sub4;
          if (class47.anInt803 == -1 && class47.anIntArray805 == null) {
          ...
          class22.method250(i_185_, 768, i_188_, i_196_, i_197_,
              i_186_, 0, i, 0, i_195_, class50_sub1_sub4, -930);
        }
      }
    }
      ...
      for (int i_215_ = 0; i_215_ < 64; i_215_++) {
        for (int i_216_ = 0; i_216_ < 64; i_216_++) {
          if (i_212_ + i_215_ > 0 && i_212_ + i_215_ < 103
            ...
            class46s[i_214_].anIntArrayArray757[i_212_ + i_215_][i
                + i_216_] &= ~0x1000000;
          }
        }
      }
  ...
  public void method179(int i, CollisionMap[] class46s, int i_237_,
      int i_238_, Scene class22, byte[] is) {
    if (i_238_ < 0) {
      Buffer class50_sub1_sub2 = new Buffer(is);
      int i_239_ = -1;
      for (; ; ) {
        ...
        for (; ; ) {
          ...
          int i_246_ = class50_sub1_sub2.readUByte();
          int i_247_ = i_246_ >> 2;
          int i_248_ = i_246_ & 0x3;
          int i_249_ = i_244_ + i_237_;
          int i_250_ = i_243_ + i;
          if (i_249_ > 0 && i_250_ > 0 && i_249_ < 103
              && i_250_ < 103) {
            int i_251_ = i_245_;
        ...
        for (int i_257_ = i; i_257_ <= i + i_255_; i_257_++) {
          if (i_257_ >= 0 && i_257_ < anInt151 && i_256_ >= 0
            ...
            if (i_257_ == i && i_257_ > 0) {
              anIntArrayArrayArray149[0][i_257_][i_256_] = anIntArrayArrayArray149[0][i_257_
                  - 1][i_256_];
            }
            ...
            if (i_256_ == i_252_ && i_256_ > 0) {
              anIntArrayArrayArray149[0][i_257_][i_256_] = anIntArrayArrayArray149[0][i_257_][i_256_
                  - 1];
            }
  ...
  public void method183(int i, byte i_272_, int i_273_,
      Buffer class50_sub1_sub2, int i_274_, int i_275_, int i_276_,
      int i_277_) {
    if (i_272_ != -61) {
    ...
    if (i_275_ >= 0 && i_275_ < 104 && i_277_ >= 0 && i_277_ < 104) {
      ...
      for (; ; ) {
        int i_278_ = class50_sub1_sub2.readUByte();
        if (i_278_ == 0) {
          if (i_276_ == 0) {
            anIntArrayArrayArray149[0][i_275_][i_277_] = -method184(
                932731 + i_275_ + i, 556238 + i_277_ + i_273_) * 8;
          } else {
            anIntArrayArrayArray149[i_276_][i_275_][i_277_] =
                anIntArrayArrayArray149[i_276_ - 1][i_275_][i_277_] - 240;
            break;
          }
          break;
        }
        if (i_278_ == 1) {
          int i_279_ = class50_sub1_sub2.readUByte();
          if (i_279_ == 1) {
            i_279_ = 0;
          }
          if (i_276_ == 0) {
        ...
        if (i_278_ <= 49) {
          aByteArrayArrayArray155[i_276_][i_275_][i_277_] = class50_sub1_sub2
              .readByte();
          aByteArrayArrayArray153[i_276_][i_275_][i_277_] = (byte) ((i_278_ - 2) / 4);
          aByteArrayArrayArray142[i_276_][i_275_][i_277_] = (byte) (i_278_
              - 2 + i_274_ & 0x3);
        } else if (i_278_ <= 81) {
      ...
      for (; ; ) {
        int i_280_ = class50_sub1_sub2.readUByte();
        if (i_280_ == 0) {
          break;
        }
        if (i_280_ == 1) {
