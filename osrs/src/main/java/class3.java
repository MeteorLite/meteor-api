public class Class3 {
    ...
    public static final int[] POWERS_OF_TWO = new int[]{1, 2, 4, 8};
    public static final int[] WALL_CORNER_ORIENTATION = new int[]{16, 32, 64, 128};
    ...
    public static void forceRenderObject(Class36 worldController, int plane, int var2, boolean var3, int objectId, int type, int face, Class18 collisionMap, int[][][] var8, int y, int x) {
        int vertexHeightSW = var8[plane][x][y];
        int vertexHeightSE = var8[plane][x + 1][y];
        int vertexHeightNE = var8[plane][x + 1][y + 1];
        int vertexHeightNW = var8[plane][x][y + 1];
        ...
        if (var3) {
            ...
            if (type == 22) {
                if (definition.animationId == -1) {
                    renderable = definition.getModel(22, face, vertexHeightSW, vertexHeightSE, vertexHeightNE, vertexHeightNW, -1);
                } else {
                    renderable = new GameObject(22, face, definition.animationId, objectId, vertexHeightNE, anInt66, true, vertexHeightSE, vertexHeightNW, vertexHeightSW);
                }

                worldController.addGroundDecoration(drawHeight, renderable, x, var2, hash, true, config, y);
                if (definition.solid && definition.hasActions) {
                    collisionMap.markBlocked(true, x, y);
                }
                ...
                if (type != 10 && type != 11) {
                    if (type >= 12) {
                        if (definition.animationId == -1) {
                            renderable = definition.getModel(type, face, vertexHeightSW, vertexHeightSE, vertexHeightNE, vertexHeightNW, -1);
                        } else {
                            renderable = new GameObject(type, face, definition.animationId, objectId, vertexHeightNE, anInt66, true, vertexHeightSE, vertexHeightNW, vertexHeightSW);
                        }

                        worldController.addRenderable(-323, x, y, 1, var2, drawHeight, renderable, config, 1, 0, hash);
                        if (definition.solid) {
                            collisionMap.markSolidOccupant(definition.sizeX, x, definition.sizeY, y, face, definition.walkable, 9);
                        }

                    } else if (type == 0) {
                        if (definition.animationId == -1) {
                            renderable = definition.getModel(0, face, vertexHeightSW, vertexHeightSE, vertexHeightNE, vertexHeightNW, -1);
                        } else {
                            renderable = new GameObject(0, face, definition.animationId, objectId, vertexHeightNE, anInt66, true, vertexHeightSE, vertexHeightNW, vertexHeightSW);
                        }

                        worldController.addWall(POWERS_OF_TWO[face], null, drawHeight, x, var2, config, -30992, 0, hash, renderable, y);
                        if (definition.solid) {
                            collisionMap.markWall(face, type, definition.walkable, y, (byte) 25, x);
                        }

                    } else if (type == 1) {
                        if (definition.animationId == -1) {
                            renderable = definition.getModel(1, face, vertexHeightSW, vertexHeightSE, vertexHeightNE, vertexHeightNW, -1);
                        } else {
                            renderable = new GameObject(1, face, definition.animationId, objectId, vertexHeightNE, anInt66, true, vertexHeightSE, vertexHeightNW, vertexHeightSW);
                        }

                        worldController.addWall(WALL_CORNER_ORIENTATION[face], null, drawHeight, x, var2, config, -30992, 0, hash, renderable, y);
                        if (definition.solid) {
                            collisionMap.markWall(face, type, definition.walkable, y, (byte) 25, x);
                        }
                        ...
                        if (type == 2) {
                            ...
                            if (definition.animationId == -1) {
                                renderable2 = definition.getModel(2, 4 + face, vertexHeightSW, vertexHeightSE, vertexHeightNE, vertexHeightNW, -1);
                                renderable1 = definition.getModel(2, tmp, vertexHeightSW, vertexHeightSE, vertexHeightNE, vertexHeightNW, -1);
                            } else {
                                renderable2 = new GameObject(2, 4 + face, definition.animationId, objectId, vertexHeightNE, anInt66, true, vertexHeightSE, vertexHeightNW, vertexHeightSW);
                                renderable1 = new GameObject(2, tmp, definition.animationId, objectId, vertexHeightNE, anInt66, true, vertexHeightSE, vertexHeightNW, vertexHeightSW);
                            }

                            worldController.addWall(POWERS_OF_TWO[face], renderable1, drawHeight, x, var2, config, -30992, POWERS_OF_TWO[tmp], hash, renderable2, y);
                            if (definition.solid) {
                                collisionMap.markWall(face, type, definition.walkable, y, (byte) 25, x);
                            }
                            ...
                            if (definition.animationId == -1) {
                                renderable = definition.getModel(3, face, vertexHeightSW, vertexHeightSE, vertexHeightNE, vertexHeightNW, -1);
                            } else {
                                renderable = new GameObject(3, face, definition.animationId, objectId, vertexHeightNE, anInt66, true, vertexHeightSE, vertexHeightNW, vertexHeightSW);
                            }
                            ...
                            if (type == 4) {
                                if (definition.animationId == -1) {
                                    renderable = definition.getModel(4, 0, vertexHeightSW, vertexHeightSE, vertexHeightNE, vertexHeightNW, -1);
                                } else {
                                    renderable = new GameObject(4, 0, definition.animationId, objectId, vertexHeightNE, anInt66, true, vertexHeightSE, vertexHeightNW, vertexHeightSW);
                                }

                                worldController.addWallDecoration(POWERS_OF_TWO[face], renderable, config, y, drawHeight, 0, (byte) -18, face * 512, var2, x, 0, hash);
                            } else if (type == 5) {
                                tmp = 16;
                                sizeX = worldController.getWallObjectHash(var2, x, y);
                                if (sizeX > 0) {
                                    tmp = GameObjectDefinition.get(sizeX >> 14 & 32767).anInt234;
                                }

                                if (definition.animationId == -1) {
                                    renderable1 = definition.getModel(4, 0, vertexHeightSW, vertexHeightSE, vertexHeightNE, vertexHeightNW, -1);
                                } else {
                                    renderable1 = new GameObject(4, 0, definition.animationId, objectId, vertexHeightNE, anInt66, true, vertexHeightSE, vertexHeightNW, vertexHeightSW);
                                }

                                worldController.addWallDecoration(POWERS_OF_TWO[face], renderable1, config, y, drawHeight, anIntArray87[face] * tmp, (byte) -18, face * 512, var2, x, anIntArray88[face] * tmp, hash);
                            } else if (type == 6) {
                                if (definition.animationId == -1) {
                                    renderable = definition.getModel(4, 0, vertexHeightSW, vertexHeightSE, vertexHeightNE, vertexHeightNW, -1);
                                } else {
                                ...
                                worldController.addWallDecoration(256, renderable, config, y, drawHeight, 0, (byte) -18, face, var2, x, 0, hash);
                            } else if (type == 7) {
                                if (definition.animationId == -1) {
                                    renderable = definition.getModel(4, 0, vertexHeightSW, vertexHeightSE, vertexHeightNE, vertexHeightNW, -1);
                                } else {
                                ...
                                worldController.addWallDecoration(512, renderable, config, y, drawHeight, 0, (byte) -18, face, var2, x, 0, hash);
                            } else {
                                if (type == 8) {
                                    if (definition.animationId == -1) {
                                        renderable = definition.getModel(4, 0, vertexHeightSW, vertexHeightSE, vertexHeightNE, vertexHeightNW, -1);
                                    ...
                                    worldController.addWallDecoration(768, renderable, config, y, drawHeight, 0, (byte) -18, face, var2, x, 0, hash);
                                }
                    ...
                    if (definition.animationId == -1) {
                        renderable = definition.getModel(10, face, vertexHeightSW, vertexHeightSE, vertexHeightNE, vertexHeightNW, -1);
                    } else {
                        renderable = new GameObject(10, face, definition.animationId, objectId, vertexHeightNE, anInt66, true, vertexHeightSE, vertexHeightNW, vertexHeightSW);
                    }
                    ...
                    if (renderable != null) {
                        ...
                        worldController.addRenderable(-323, x, y, sizeY, var2, drawHeight, renderable, config, sizeX, rotation, hash);
                    }
            ...
            if (var5 == 22) {
                if (!aBoolean67 || var15.hasActions || var15.aBoolean249) {
                    if (var15.animationId == -1) {
                        ...
                        var18 = new GameObject(22, var4, var15.animationId, var8, var12, anInt66, true, var11, var13, var10);
                    }

                    var7.addGroundDecoration(var14, var18, var9, var2, var16, true, var17, var6);
                ...
                if (var5 != 10 && var5 != 11) {
                    if (var5 >= 12) {
                        if (var15.animationId == -1) {
                            ...
                            var18 = new GameObject(var5, var4, var15.animationId, var8, var12, anInt66, true, var11, var13, var10);
                        }

                        var7.addRenderable(-323, var9, var6, 1, var2, var14, var18, var17, 1, 0, var16);
                        ...
                        if (var15.animationId == -1) {
                            ...
                            var18 = new GameObject(0, var4, var15.animationId, var8, var12, anInt66, true, var11, var13, var10);
                        }

                        var7.addWall(POWERS_OF_TWO[var4], null, var14, var9, var2, var17, -30992, 0, var16, var18, var6);
                        if (var4 == 0) {
                        ...
                        if (var15.animationId == -1) {
                            ...
                            var18 = new GameObject(1, var4, var15.animationId, var8, var12, anInt66, true, var11, var13, var10);
                        }

                        var7.addWall(WALL_CORNER_ORIENTATION[var4], null, var14, var9, var2, var17, -30992, 0, var16, var18, var6);
                        if (var15.aBoolean241) {
                            if (var4 == 0) {
                                this.aByteArrayArrayArray77[var2][var9][var6 + 1] = 50;
                            } else if (var4 == 1) {
                        ...
                        if (var5 == 2) {
                            ...
                            Renderable var27;
                            if (var15.animationId == -1) {
                                var27 = var15.getModel(2, 4 + var4, var10, var11, var12, var13, -1);
                                var28 = var15.getModel(2, var26, var10, var11, var12, var13, -1);
                            } else {
                                var27 = new GameObject(2, 4 + var4, var15.animationId, var8, var12, anInt66, true, var11, var13, var10);
                                var28 = new GameObject(2, var26, var15.animationId, var8, var12, anInt66, true, var11, var13, var10);
                            }

                            var7.addWall(POWERS_OF_TWO[var4], var28, var14, var9, var2, var17, -30992, POWERS_OF_TWO[var26], var16, var27, var6);
                            if (var15.aBoolean232) {
                                if (var4 == 0) {
                                    this.anIntArrayArrayArray84[var2][var9][var6] |= 585;
                                    this.anIntArrayArrayArray84[var2][var9][var6 + 1] |= 1170;
                            ...
                            if (var15.animationId == -1) {
                                ...
                                var18 = new GameObject(3, var4, var15.animationId, var8, var12, anInt66, true, var11, var13, var10);
                            }
                            ...
                            if (var5 == 4) {
                                if (var15.animationId == -1) {
                                    ...
                                    var18 = new GameObject(4, 0, var15.animationId, var8, var12, anInt66, true, var11, var13, var10);
                                }

                                var7.addWallDecoration(POWERS_OF_TWO[var4], var18, var17, var6, var14, 0, (byte) -18, var4 * 512, var2, var9, 0, var16);
                            } else if (var5 == 5) {
                                var26 = 16;
                                var19 = var7.getWallObjectHash(var2, var9, var6);
                                if (var19 > 0) {
                                    var26 = GameObjectDefinition.get(var19 >> 14 & 32767).anInt234;
                                }

                                if (var15.animationId == -1) {
                                    var28 = var15.getModel(4, 0, var10, var11, var12, var13, -1);
                                } else {
                                    var28 = new GameObject(4, 0, var15.animationId, var8, var12, anInt66, true, var11, var13, var10);
                                }

                                var7.addWallDecoration(POWERS_OF_TWO[var4], var28, var17, var6, var14, anIntArray87[var4] * var26, (byte) -18, var4 * 512, var2, var9, anIntArray88[var4] * var26, var16);
                            } else if (var5 == 6) {
                                if (var15.animationId == -1) {
                                    var18 = var15.getModel(4, 0, var10, var11, var12, var13, -1);
                                } else {
                                ...
                                var7.addWallDecoration(256, var18, var17, var6, var14, 0, (byte) -18, var4, var2, var9, 0, var16);
                            } else if (var5 == 7) {
                                if (var15.animationId == -1) {
                                    var18 = var15.getModel(4, 0, var10, var11, var12, var13, -1);
                                } else {
                                ...
                                var7.addWallDecoration(512, var18, var17, var6, var14, 0, (byte) -18, var4, var2, var9, 0, var16);
                            } else {
                                if (var5 == 8) {
                                    if (var15.animationId == -1) {
                                        var18 = var15.getModel(4, 0, var10, var11, var12, var13, -1);
                                    ...
                                    var7.addWallDecoration(768, var18, var17, var6, var14, 0, (byte) -18, var4, var2, var9, 0, var16);
                                }
                    ...
                    if (var15.animationId == -1) {
                        ...
                        var18 = new GameObject(10, var4, var15.animationId, var8, var12, anInt66, true, var11, var13, var10);
                    }
                    ...
                    if (var18 != null) {
                        ...
                        if (var7.addRenderable(-323, var9, var6, var20, var2, var14, var18, var17, var19, var21, var16) && var15.aBoolean241) {
                            Model var22;
            ...
            for (var5 = 0; var5 < 104; ++var5) {
                for (var6 = 0; var6 < 104; ++var6) {
                    if ((this.aByteArrayArrayArray72[var4][var5][var6] & 1) == 1) {
                        ...
                        if (var7 >= 0) {
                            var1[var7].markBlocked(true, var5, var6);
                        }
                    }
                }
            }
