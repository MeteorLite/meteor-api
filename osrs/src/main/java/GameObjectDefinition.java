...
public class GameObjectDefinition {
  ...
  public Model method206(int var1, boolean var2, int var3, int var4) {
    ...
    if (this.anIntArray220 == null) {
      ...
      for (var11 = 0; var11 < var10; ++var11) {
        ...
        var5 = (Model) aClass39_252.method339(var12);
        if (var5 == null) {
          ...
          aClass39_252.method340(201, var12, var5);
        }
      ...
      var5 = (Model) aClass39_252.method339(var10);
      if (var5 == null) {
        ...
        aClass39_252.method340(201, var10, var5);
      }
    }

    boolean var15 = this.anInt242 != 128 || this.anInt243 != 128 || this.anInt244 != 128;
    var9 = this.anInt245 != 0 || this.anInt246 != 0 || this.anInt247 != 0;
    Model var17 = new Model(this.anIntArray223 == null, Class11.method211(var3), var5, true,
        var1 == 0 && var3 == -1 && !var15 && !var9);
    if (var3 != -1) {
      var17.method510();
    ...
    while (true) {
      ...
      do {
        while (true) {
          ...
          if (var4 == 0) {
            if (var3 == -1) {
              this.hasActions = this.anIntArray219 != null && (this.anIntArray220 == null
                  || this.anIntArray220[0] == 10);
  ...
  public static void method197(Class47 var0) {
    aBuffer_214 = new Buffer(var0.method546("loc.dat", null), (byte) 1);
    Buffer var1 = new Buffer(var0.method546("loc.idx", null), (byte) 1);
