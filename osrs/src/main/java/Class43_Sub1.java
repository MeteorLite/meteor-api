...
public class Class43_Sub1 extends Class43
    ...
    public void method383(Class47 class47, Client client1) {
        ...
        aClient1283 = client1;
        aBoolean1282 = true;
        aClient1283.startRunnable(this, 2);
    }
    ...
    public void run() {
        try {
            while (aBoolean1282) {
                ...
                boolean flag = false;
                for (Class44_Sub3_Sub3 class44_sub3_sub3 = (Class44_Sub3_Sub3) aClass28_1291.peekFront(); class44_sub3_sub3 != null; class44_sub3_sub3 = (Class44_Sub3_Sub3) aClass28_1291.getPrevious(aByte1269))
                ...
                if (!flag) {
                    for (Class44_Sub3_Sub3 class44_sub3_sub3_1 = (Class44_Sub3_Sub3) aClass28_1291.peekFront(); class44_sub3_sub3_1 != null; class44_sub3_sub3_1 = (Class44_Sub3_Sub3) aClass28_1291.getPrevious(aByte1269)) {
                        flag = true;
    ...
    public void method399(boolean flag) {
        anInt1286 = 0;
        anInt1287 = 0;
        Class44_Sub3_Sub3 class44_sub3_sub3 = (Class44_Sub3_Sub3) aClass28_1291.peekFront();
        if (flag) {
            for (int i = 1; i > 0; i++) ;
        }
        for (; class44_sub3_sub3 != null; class44_sub3_sub3 = (Class44_Sub3_Sub3) aClass28_1291.getPrevious(aByte1269))
            if (class44_sub3_sub3.aBoolean1391)
                anInt1286++;
            else
                anInt1287++;
                ...
                if (aClass44_Sub3_Sub3_1301 != null) {
                    ...
                    if (l1 == 0) {
                        ...
                        if (aClass44_Sub3_Sub3_1301.aBoolean1391)
                            ...
                            aClass44_Sub3_Sub3_1301.unlink();
                        aClass44_Sub3_Sub3_1301 = null;
                    } else {
        ...
        try {
            if (aSocket1297 == null) {
                ...
                if (l - aLong1308 < 4000L)
                    return;
                aLong1308 = l;
                aSocket1297 = aClient1283.method72(43594 + Client.portOffset);
