...
public class Class43_Sub1 implements Runnable {
  ...
  public void method392(int var1, int var2) {
    if (var1 >= 0 && var1 <= this.anIntArrayArray1271.length && var2 >= 0
        && var2 <= this.anIntArrayArray1271[var1].length) {
      if (this.anIntArrayArray1271[var1][var2] != 0) {
        synchronized (this.aClass31_1288) {
          Class44_Sub3_Sub3 var4;
          for (var4 = (Class44_Sub3_Sub3) this.aClass31_1288.method266(); var4 != null;
              var4 = (Class44_Sub3_Sub3) this.aClass31_1288.method267(this.aByte1269)) {
  ...
  public void method395(byte var1, int var2, int var3, byte var4) {
    if (this.aClient1283.aClass45Array1225[0] != null) {
      if (this.anIntArrayArray1271[var3][var2] != 0) {
        ...
        if (!this.method402((byte) 103, this.anIntArrayArray1272[var3][var2],
            this.anIntArrayArray1271[var3][var2], var5)) {
  ...
  public void method398(byte var1) {
    if (var1 == 7) {
      ...
      while (var2 != null) {
        ...
        byte[] var3 = null;
        if (this.aClient1283.aClass45Array1225[0] != null) {
          var3 = this.aClient1283.aClass45Array1225[var2.anInt1387 + 1].method538((byte) 2,
              var2.anInt1388);
        }

        if (!this.method402((byte) 103, this.anIntArrayArray1272[var2.anInt1387][var2.anInt1388],
            this.anIntArrayArray1271[var2.anInt1387][var2.anInt1388], var3)) {
          var3 = null;
        }
  ...
  public void method399() {
    ...
    for (Class44_Sub3_Sub3 var1 = (Class44_Sub3_Sub3) this.aClass28_1291.peekFront(); var1 != null;
        var1 = (Class44_Sub3_Sub3) this.aClass28_1291.getPrevious(this.aByte1269)) {
  ...
  public void method401() {
    try {
      ...
      if (this.anInt1303 == 0 && var1 >= 6) {
        ...
        int var2;
        for (var2 = 0; var2 < 6;
            var2 += this.anInputStream1298.read(this.aByteArray1304, var2, 6 - var2)) {
        }
        ...
        for (Class44_Sub3_Sub3 var6 = (Class44_Sub3_Sub3) this.aClass28_1291.peekFront();
            var6 != null;
            var6 = (Class44_Sub3_Sub3) this.aClass28_1291.getPrevious(this.aByte1269)) {
      ...
      if (this.anInt1303 > 0 && var1 >= this.anInt1303) {
        ...
        for (var4 = 0; var4 < this.anInt1303;
            var4 += this.anInputStream1298.read(var13, var4 + var3, this.anInt1303 - var4)) {
        }

        if (this.anInt1303 + this.anInt1302 >= var13.length
            && this.aClass44_Sub3_Sub3_1301 != null) {
          if (this.aClient1283.aClass45Array1225[0] != null) {
            this.aClient1283.aClass45Array1225[this.aClass44_Sub3_Sub3_1301.anInt1387
                + 1].method539(var13.length, this.aClass44_Sub3_Sub3_1301.anInt1388, var13,
                (byte) 8);
          }

          if (!this.aClass44_Sub3_Sub3_1301.aBoolean1391
              && this.aClass44_Sub3_Sub3_1301.anInt1387 == 3) {
  ...
  public void method383(Class47 var1, Client var2) {
    ...
    for (int var4 = 0; var4 < 4; ++var4) {
      var5 = var1.method546(var3[var4], null);
      var6 = var5.length / 2;
    ...
    for (int var11 = 0; var11 < 4; ++var11) {
      byte[] var12 = var1.method546(var10[var11], null);
    ...
    var5 = var1.method546("model_index", null);
    ...
    var5 = var1.method546("map_index", null);
    var7 = new Buffer(var5, (byte) 1);
    var6 = var5.length / 7;
    ...
    var5 = var1.method546("anim_index", null);
    var7 = new Buffer(var5, (byte) 1);
    var6 = var5.length / 2;
    ...
    var5 = var1.method546("midi_index", null);
    var7 = new Buffer(var5, (byte) 1);
    var6 = var5.length;
    ...
    while (true) {
      try {
        if (this.aBoolean1282) {
          ...
          for (var3 = (Class44_Sub3_Sub3) this.aClass28_1291.peekFront(); var3 != null;
              var3 = (Class44_Sub3_Sub3) this.aClass28_1291.getPrevious(this.aByte1269)) {
          ...
          if (!this.aClient1283.aBoolean905 || this.aSocket1297 == null
              || this.anOutputStream1299 == null
              || this.anInt1274 <= 0 && this.aClient1283.aClass45Array1225[0] != null) {
            continue;
          }
