...
public class Class44_Sub3_Sub4_Sub5 extends Renderable {
	...
	public Class44_Sub3_Sub4_Sub5(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
	...
	public Model getModel(boolean var1) {
		...
		if (var2 == null) {
			...
			if (this.aClass32_1589.anInt554 != 128 || this.aClass32_1589.anInt555 != 128) {
				var4.method519(9, this.aClass32_1589.anInt554, this.aClass32_1589.anInt554, this.aClass32_1589.anInt555);
			}
			...
			var4.method520(this.aClass32_1589.anInt557 + 64, this.aClass32_1589.anInt558 + 850, -30, -50, -30, true);
			return var4;
		}
	}
	...
	public void method528(int var1, int var2) {
		...
		while (true) {
			do {
				do {
					if (this.anInt1596 <= this.aClass32_1589.aClass26_551.getFrameLength(this.anInt1595, 41645)) {
						return;
					}

					this.anInt1596 -= this.aClass32_1589.aClass26_551.getFrameLength(this.anInt1595, 41645) + 1;
					++this.anInt1595;
