...
public class MouseHandler implements MouseListener, MouseMotionListener, FocusListener {
	...
	public final synchronized void mousePressed(MouseEvent var1) {
		if (MouseHandler_instance != null) { // L: 74
			...
			MouseHandler_lastPressedTimeMillisVolatile = class136.getServerTime(); // L: 78
		...
		for (int var1 = 0; var1 < Client.field547; ++var1) { // L: 8207
			...
			if ((var4 & 1) != 0) { // L: 8215
				...
				if (class431.field4602) { // L: 8218
					var3.field1144 = var0.readUnsignedByteAdd() == 1; // L: 8219
				}
			...
			if ((var4 & 128) != 0) { // L: 8238
				...
				var6 = var0.readUnsignedByteNeg(); // L: 8261
				if (var6 > 0) { // L: 8262
					for (var7 = 0; var7 < var6; ++var7) { // L: 8263
						...
						if (var9 != 32767) { // L: 8266
							...
							int var12 = var9 > 0 ? var0.readUnsignedByteAdd() : var11; // L: 8269
			...
			if (class431.field4602 && (var4 & 256) != 0 || !class431.field4602 && (var4 & 64) != 0) { // L: 8276
				var3.field1129 = var0.readByteSub(); // L: 8277
				var3.field1160 = var0.readByteAdd(); // L: 8278
			...
			if ((var4 & 512) != 0) { // L: 8291
				...
				var3.field1114 = var0.readByteAdd(); // L: 8295
				var3.field1171 = var0.readByteAdd(); // L: 8296
				var3.field1122 = (byte)var0.readUnsignedByteSub(); // L: 8297
			}
			...
			if ((var4 & 8) != 0) { // L: 8319
				...
				var6 = var0.readUnsignedByteAdd(); // L: 8324
