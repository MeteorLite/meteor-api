...
public class GameObject extends Renderable {
  ...
  public GameObject(int var1, int var2, int var3, int var4, int var5, int var6, boolean var7,
    ...
    if (var7 && this.animation.frameStep != -1) {
      ...
      this.nextFrameTime -= (int) (Math.random() * (double) this.animation.getFrameLength(
          this.frame, 41645));
    }
  ...
  public Model getModel(boolean var1) {
    ...
    return var3.getModel(this.type, this.orientation, this.minX, this.minY, this.maxX, this.maxY,
        var2);
  }
}
