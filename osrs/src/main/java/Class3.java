...
public class Class3 {
	...
	public int method164(int var1, int var2, int var3, int var4) {
		return (this.aByteArrayArrayArray72[var1][var4][var2] & 8) != 0 ? 0 : (var1 > 0 && (this.aByteArrayArrayArray72[1][var4][var2] & 2) != 0 ? var1 - 1 : var1);
	}
		...
		if (var5 == 22) {
			...
			if (var5 != 10 && var5 != 11) {
				...
				if (var5 >= 12) {
					...
					var7.addRenderable(-323, var9, var6, 1, var2, var14, (Renderable)var18, var17, 1, 0, var16);
					...
					var7.addWall(POWERS_OF_TWO[var4], (Renderable)null, var14, var9, var2, var17, -30992, 0, var16, (Renderable)var18, var6);
					if (var4 == 0) {
					...
					var7.addWall(WALL_CORNER_ORIENTATION[var4], (Renderable)null, var14, var9, var2, var17, -30992, 0, var16, (Renderable)var18, var6);
					if (var15.aBoolean241) {
						if (var4 == 0) {
							this.aByteArrayArrayArray77[var2][var9][var6 + 1] = 50;
						} else if (var4 == 1) {
					...
					if (var5 == 2) {
						...
						if (var15.animationId == -1) {
							...
							var27 = new GameObject(2, var4 + 4, var15.animationId, var8, var12, anInt66, true, var11, var13, var10);
							var26 = new GameObject(2, var20, var15.animationId, var8, var12, anInt66, true, var11, var13, var10);
						}

						var7.addWall(POWERS_OF_TWO[var4], (Renderable)var26, var14, var9, var2, var17, -30992, POWERS_OF_TWO[var20], var16, (Renderable)var27, var6);
						if (var15.aBoolean232) {
							if (var4 == 0) {
								var10000 = this.anIntArrayArrayArray84[var2][var9];
								var10000[var6] |= 585;
						...
						if (var5 == 4) {
							...
							var7.addWallDecoration(POWERS_OF_TWO[var4], (Renderable)var18, var17, var6, var14, 0, (byte)-18, var4 * 512, var2, var9, 0, var16);
						} else if (var5 == 5) {
							var20 = 16;
							...
							if (var15.animationId == -1) {
								...
								var26 = new GameObject(4, 0, var15.animationId, var8, var12, anInt66, true, var11, var13, var10);
							}

							var7.addWallDecoration(POWERS_OF_TWO[var4], (Renderable)var26, var17, var6, var14, var20 * anIntArray87[var4], (byte)-18, var4 * 512, var2, var9, var20 * anIntArray88[var4], var16);
						} else if (var5 == 6) {
							if (var15.animationId == -1) {
								var18 = var15.getModel(4, 0, var10, var11, var12, var13, -1);
							} else {
							...
							var7.addWallDecoration(256, (Renderable)var18, var17, var6, var14, 0, (byte)-18, var4, var2, var9, 0, var16);
						} else if (var5 == 7) {
							if (var15.animationId == -1) {
								var18 = var15.getModel(4, 0, var10, var11, var12, var13, -1);
							} else {
							...
							var7.addWallDecoration(512, (Renderable)var18, var17, var6, var14, 0, (byte)-18, var4, var2, var9, 0, var16);
						} else if (var5 == 8) {
							if (var15.animationId == -1) {
								var18 = var15.getModel(4, 0, var10, var11, var12, var13, -1);
							} else {
							...
							var7.addWallDecoration(768, (Renderable)var18, var17, var6, var14, 0, (byte)-18, var4, var2, var9, 0, var16);
						}
					}
				}
			} else {
				...
				if (var18 != null) {
					...
					if (var7.addRenderable(-323, var9, var6, var21, var2, var14, (Renderable)var18, var17, var19, var20, var16) && var15.aBoolean241) {
						Model var22;
	...
	public void method163(Class18[] var1, boolean var2, Class36 var3) {
		...
		for (var4 = 0; var4 < 4; ++var4) {
			...
			byte var23 = -10;
			byte var24 = -50;
			var7 = (int)Math.sqrt((double)(var22 * var22 + var23 * var23 + var24 * var24));
			var8 = var21 * var7 >> 8;

			for (var9 = 1; var9 < this.anInt70 - 1; ++var9) {
				for (var10 = 1; var10 < this.anInt69 - 1; ++var10) {
					var11 = this.anIntArrayArrayArray71[var4][var10 + 1][var9] - this.anIntArrayArrayArray71[var4][var10 - 1][var9];
					var12 = this.anIntArrayArrayArray71[var4][var10][var9 + 1] - this.anIntArrayArrayArray71[var4][var10][var9 - 1];
					var13 = (int)Math.sqrt((double)(var11 * var11 + var12 * var12 + 65536));
					var14 = (var11 << 8) / var13;
					var15 = 65536 / var13;
					var16 = (var12 << 8) / var13;
					var17 = (var22 * var14 + var23 * var15 + var24 * var16) / var8 + var20;
					var18 = (var19[var10 - 1][var9] >> 2) + (var19[var10][var9 - 1] >> 2) + (var19[var10 + 1][var9] >> 3) + (var19[var10][var9 + 1] >> 3) + (var19[var10][var9] >> 1);
			...
			for (var11 = -5; var11 < this.anInt69 + 5; ++var11) {
				...
				if (var11 >= 1 && var11 < this.anInt69 - 1) {
					...
					for (var18 = -5; var18 < this.anInt70 + 5; ++var18) {
						...
						if (var18 >= 1 && var18 < this.anInt70 - 1 && (!aBoolean67 || (this.aByteArrayArrayArray72[var4][var11][var18] & 16) == 0 && this.method164(var4, var18, 11451, var11) == anInt68)) {
							...
							if (var27 > 0 || var28 > 0) {
								...
								if (var4 > 0) {
									boolean var52 = var27 != 0 || this.aByteArrayArrayArray75[var4][var11][var18] == 0;
								...
								if (var28 == 0) {
									var3.method283(var4, var11, var18, 0, 0, -1, var29, var30, var31, var32, method170(var37, var33), method170(var37, var34), method170(var37, var35), method170(var37, var36), 0, 0, 0, 0, var39, 0);
								} else {
									...
									if (var43 >= 0) {
										...
										var45 = Class44_Sub3_Sub1_Sub1.anIntArray1419[this.method171(var42.anInt434, 96)];
									}

									var3.method283(var4, var11, var18, var40, var53, var43, var29, var30, var31, var32, method170(var37, var33), method170(var37, var34), method170(var37, var35), method170(var37, var36), this.method171(var44, var33), this.method171(var44, var34), this.method171(var44, var35), this.method171(var44, var36), var39, var45);
								}
							}
						}
					}
				...
				for (var7 = 0; var7 <= this.anInt70; ++var7) {
					for (var8 = 0; var8 <= this.anInt69; ++var8) {
						...
						if ((this.anIntArrayArrayArray84[var49][var8][var7] & var6) != 0) {
							...
							for (var12 = var49; var9 > 0 && (this.anIntArrayArrayArray84[var49][var8][var9 - 1] & var6) != 0; --var9) {
							}

							while (var10 < this.anInt70 && (this.anIntArrayArrayArray84[var49][var8][var10 + 1] & var6) != 0) {
								++var10;
							}
							...
							if (var13 >= 8) {
								...
								Class36.method281(var48, var15, var10 * 128 + 128, (byte)0, var8 * 128, var8 * 128, var9 * 128, var16, 1);
						...
						if ((this.anIntArrayArrayArray84[var49][var8][var7] & var46) != 0) {
							...
							for (var12 = var49; var9 > 0 && (this.anIntArrayArrayArray84[var49][var9 - 1][var7] & var46) != 0; --var9) {
							}

							while (var10 < this.anInt69 && (this.anIntArrayArrayArray84[var49][var10 + 1][var7] & var46) != 0) {
								++var10;
							}
							...
							if (var13 >= 8) {
								...
								Class36.method281(var48, var15, var7 * 128, (byte)0, var9 * 128, var10 * 128 + 128, var7 * 128, var16, 2);
						...
						if ((this.anIntArrayArrayArray84[var49][var8][var7] & var47) != 0) {
							...
							for (var12 = var7; var11 > 0 && (this.anIntArrayArrayArray84[var49][var8][var11 - 1] & var47) != 0; --var11) {
							}

							while (var12 < this.anInt70 && (this.anIntArrayArrayArray84[var49][var8][var12 + 1] & var47) != 0) {
								++var12;
							}
							...
							if ((var10 - var9 + 1) * (var12 - var11 + 1) >= 4) {
								...
								Class36.method281(var48, var13, var12 * 128 + 128, (byte)0, var9 * 128, var10 * 128 + 128, var11 * 128, var13, 4);
	...
	public static int method165(int var0, int var1) {
		int var2 = method166(var0 + 45365, var1 + 91923, 4) - 128 + (method166(var0 + 10294, var1 + 37821, 2) - 128 >> 1) + (method166(var0, var1, 1) - 128 >> 2);
	...
	public static void forceRenderObject(Class36 var0, int var1, int var2, boolean var3, int var4, int var5, int var6, Class18 var7, int[][][] var8, int var9, int var10) {
		...
		if (var3) {
			...
			if (var5 == 22) {
				if (var16.animationId == -1) {
					...
					var19 = new GameObject(22, var6, var16.animationId, var4, var13, anInt66, true, var12, var14, var11);
				}
				...
				if (var5 != 10 && var5 != 11) {
					if (var5 >= 12) {
						if (var16.animationId == -1) {
							...
							var19 = new GameObject(var5, var6, var16.animationId, var4, var13, anInt66, true, var12, var14, var11);
						}

						var0.addRenderable(-323, var10, var9, 1, var2, var15, (Renderable)var19, var18, 1, 0, var17);
						if (var16.solid) {
						...
						if (var16.animationId == -1) {
							...
							var19 = new GameObject(0, var6, var16.animationId, var4, var13, anInt66, true, var12, var14, var11);
						}

						var0.addWall(POWERS_OF_TWO[var6], (Renderable)null, var15, var10, var2, var18, -30992, 0, var17, (Renderable)var19, var9);
						if (var16.solid) {
						...
						if (var16.animationId == -1) {
							...
							var19 = new GameObject(1, var6, var16.animationId, var4, var13, anInt66, true, var12, var14, var11);
						}

						var0.addWall(WALL_CORNER_ORIENTATION[var6], (Renderable)null, var15, var10, var2, var18, -30992, 0, var17, (Renderable)var19, var9);
						if (var16.solid) {
							var7.markWall(var6, var5, var16.walkable, var9, (byte)25, var10);
						}
					} else {
						...
						if (var5 == 2) {
							...
							if (var16.animationId == -1) {
								...
								var23 = new GameObject(2, var6 + 4, var16.animationId, var4, var13, anInt66, true, var12, var14, var11);
								var24 = new GameObject(2, var21, var16.animationId, var4, var13, anInt66, true, var12, var14, var11);
							}

							var0.addWall(POWERS_OF_TWO[var6], (Renderable)var24, var15, var10, var2, var18, -30992, POWERS_OF_TWO[var21], var17, (Renderable)var23, var9);
							if (var16.solid) {
								var7.markWall(var6, var5, var16.walkable, var9, (byte)25, var10);
							}
						} else if (var5 == 3) {
							if (var16.animationId == -1) {
								...
								var19 = new GameObject(3, var6, var16.animationId, var4, var13, anInt66, true, var12, var14, var11);
							}
							...
							if (var5 == 4) {
								if (var16.animationId == -1) {
									...
									var19 = new GameObject(4, 0, var16.animationId, var4, var13, anInt66, true, var12, var14, var11);
								}

								var0.addWallDecoration(POWERS_OF_TWO[var6], (Renderable)var19, var18, var9, var15, 0, (byte)-18, var6 * 512, var2, var10, 0, var17);
							} else if (var5 == 5) {
								var21 = 16;
								...
								if (var16.animationId == -1) {
									...
									var24 = new GameObject(4, 0, var16.animationId, var4, var13, anInt66, true, var12, var14, var11);
								}

								var0.addWallDecoration(POWERS_OF_TWO[var6], (Renderable)var24, var18, var9, var15, anIntArray87[var6] * var21, (byte)-18, var6 * 512, var2, var10, anIntArray88[var6] * var21, var17);
							} else if (var5 == 6) {
								if (var16.animationId == -1) {
									var19 = var16.getModel(4, 0, var11, var12, var13, var14, -1);
								} else {
								...
								var0.addWallDecoration(256, (Renderable)var19, var18, var9, var15, 0, (byte)-18, var6, var2, var10, 0, var17);
							} else if (var5 == 7) {
								if (var16.animationId == -1) {
									var19 = var16.getModel(4, 0, var11, var12, var13, var14, -1);
								} else {
								...
								var0.addWallDecoration(512, (Renderable)var19, var18, var9, var15, 0, (byte)-18, var6, var2, var10, 0, var17);
							} else if (var5 == 8) {
								if (var16.animationId == -1) {
									var19 = var16.getModel(4, 0, var11, var12, var13, var14, -1);
								} else {
								...
								var0.addWallDecoration(768, (Renderable)var19, var18, var9, var15, 0, (byte)-18, var6, var2, var10, 0, var17);
							}
						}
					}
				} else {
					if (var16.animationId == -1) {
						...
						var19 = new GameObject(10, var6, var16.animationId, var4, var13, anInt66, true, var12, var14, var11);
					}
					...
					if (var19 != null) {
						...
						var0.addRenderable(-323, var10, var9, var22, var2, var15, (Renderable)var19, var18, var20, var21, var17);
					}
