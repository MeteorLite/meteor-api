...
public abstract class GameEngine extends Applet implements Runnable, FocusListener, WindowListener {
	...
	final synchronized void addCanvas() {
		...
		this.field209 = class136.getServerTime(); // L: 287
	} // L: 288
	...
	@Export("clientTick")
	void clientTick() {
		long var1 = class136.getServerTime(); // L: 351
	...
	void graphicsTick() {
		...
		long var2 = class136.getServerTime(); // L: 364
	...
	public final synchronized void paint(Graphics var1) {
		if (this == gameEngine && !isKilled) { // L: 457
			...
			if (class136.getServerTime() - this.field209 > 1000L) { // L: 459
	...
	public final void destroy() {
		if (this == gameEngine && !isKilled) { // L: 446
			stopTimeMs = class136.getServerTime(); // L: 447
	...
	public final void stop() {
		if (this == gameEngine && !isKilled) { // L: 441
			stopTimeMs = class136.getServerTime() + 4000L; // L: 442
		}
	} // L: 443
	...
	public void run() {
		try {
			...
			while (stopTimeMs == 0L || class136.getServerTime() < stopTimeMs) { // L: 336
