...
public class Class44_Sub3_Sub1_Sub2 extends Statics {
  ...
  public Class44_Sub3_Sub1_Sub2(byte[] var1, Component var2) {
    ...
    try {
      ...
      PixelGrabber var5 = new PixelGrabber(var3, 0, 0, this.anInt1432, this.anInt1433,
          this.anIntArray1431, 0, this.anInt1432);
      var5.grabPixels();
  ...
  public Class44_Sub3_Sub1_Sub2(Class47 var1, String var2, int var3) {
    ...
    this.aBoolean1429 = false;
    this.aBoolean1430 = false;
    Buffer var4 = new Buffer(var1.method546(var2 + ".dat", null), (byte) 1);
    Buffer var5 = new Buffer(var1.method546("index.dat", null), (byte) 1);
  ...
  public void method438(int var1, boolean var2, int var3) {
    ...
    if (var7 > 0 && var6 > 0) {
      this.method439(var9, var5, this.anIntArray1431, this.aBoolean1422, var6, var7, var8, var4,
          Statics.anIntArray1351);
    }

  }

  public void method444(int var1, int var2, int var3, int var4, int var5, int[] var6, int var7,
    ...
    try {
      ...
      for (var11 = 0; var11 < var4; ++var11) {
        ...
        for (var5 = -var6[var11]; var5 < 0; ++var5) {
          Statics.anIntArray1351[var20++] = this.anIntArray1431[this.anInt1432 * (var22 >> 16) + (
              var21 >> 16)];
          var21 += var15;
          var22 -= var14;
        }
  ...
  public void method440(byte var1, int var2, int var3) {
    ...
    if (var7 > 0 && var6 > 0) {
      this.method441(Statics.anIntArray1351, this.anIntArray1431, 0, var5, var4, var7, var6, var8,
          var9);
    }
  ...
  public void method445(int var1, int var2, int var3, int var4, double var5, int var7, byte var8,
      int var9, int var10) {
    try {
      int var11 = -var10 / 2;
      int var12 = -var2 / 2;
  ...
  public void method446(int var1, int var2, Class44_Sub3_Sub1_Sub3 var3, int var4) {
    ...
    if (var8 > 0 && var7 > 0) {
      this.method447(Statics.anIntArray1351, var5, var6, var7, 5, var10, var8, 0,
          var3.aByteArray1445, var9, this.anIntArray1431);
    }

  }

  public void method447(int[] var1, int var2, int var3, int var4, int var5, int var6, int var7,
      int var8, byte[] var9, int var10, int[] var11) {
    int var12 = -(var7 >> 2);
    var7 = -(var7 & 3);
  ...
  public void method443(int var1, int var2, int var3, int var4, int[] var5, int var6, int var7,
      int var8, int var9, int var10, int[] var11) {
    int var12 = 256 - var3;
    if (var8 != 0) {
    ...
    for (int var13 = -var10; var13 < 0; ++var13) {
      for (int var14 = -var4; var14 < 0; ++var14) {
        ...
        if (var6 != 0) {
          int var15 = var5[var7];
          var5[var7++] = (var3 * (var6 & 65280) + var12 * (var15 & 65280) & 16711680) + (
              (var15 & 16711935) * var12 + var3 * (var6 & 16711935) & -16711936) >> 8;
        } else {
          ++var7;
        }
      }
  ...
  public void method441(int[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7,
      int var8, int var9) {
    int var10 = -(var6 >> 2);
    var6 = -(var6 & 3);
  ...
  public void method439(int var1, int var2, int[] var3, boolean var4, int var5, int var6, int var7,
      int var8, int[] var9) {
    int var10 = -(var6 >> 2);
    if (!var4) {
      this.anInt1421 = 362;
  ...
  public void method442(int var1, int var2, int var3, int var4) {
    ...
    if (var8 > 0 && var7 > 0) {
      this.method443(var9, var10, var4, var8, Statics.anIntArray1351, 0, var5, this.anInt1426, var6,
          var7, this.anIntArray1431);
    }
  ...
  public void method437(byte var1) {
    ...
    for (int var3 = 0; var3 < this.anInt1433; ++var3) {
      if (this.anInt1432 >= 0) {
        System.arraycopy(this.anIntArray1431, var3 * this.anInt1432, var2,
            (var3 + this.anInt1435) * this.anInt1436 + this.anInt1434, this.anInt1432);
      }
    }
