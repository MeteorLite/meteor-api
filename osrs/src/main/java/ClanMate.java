...
public class ClanMate extends Buddy {
	...
	static final void method6700(class263 var0) {
		...
		if (class263.field3012 == var0) { // L: 7426
			var2 = var1.readUnsignedByteSub(); // L: 7427
			...
			if (class263.field3006 == var0) { // L: 7439
				var2 = var1.readUnsignedByteSub(); // L: 7440
				var3 = var1.readUnsignedByteAdd(); // L: 7441
				var4 = (var3 >> 4 & 7) + PlayerComposition.field3307; // L: 7442
				var5 = (var3 & 7) + class29.field181; // L: 7443
				var6 = var1.readUnsignedByteSub(); // L: 7444
			...
			if (class263.field3009 == var0) { // L: 7462
				var2 = var1.readUnsignedByteAdd(); // L: 7463
				...
				if (class263.field3004 == var0) { // L: 7484
					...
					byte var38 = var1.readByteAdd(); // L: 7487
					byte var39 = var1.readByte(); // L: 7488
					var6 = var1.method7715(); // L: 7489
					byte var40 = var1.readByteAdd(); // L: 7490
					var8 = var1.method7714(); // L: 7491
					var9 = var1.readUnsignedByteNeg(); // L: 7492
					var10 = var9 >> 2; // L: 7493
					var11 = var9 & 3; // L: 7494
					var12 = Client.field748[var10]; // L: 7495
					var13 = var1.readUnsignedByteNeg(); // L: 7496
				...
				if (class263.field3007 == var0) { // L: 7549
					...
					var2 = var1.readUnsignedByteNeg(); // L: 7573
					var3 = var1.readUnsignedShort(); // L: 7574
					var4 = var1.method7715(); // L: 7575
					var5 = var1.readUnsignedByteAdd(); // L: 7576
					...
					var2 = var1.readUnsignedByteAdd() * 4; // L: 7602
					var3 = var1.method7714(); // L: 7603
					var4 = var1.method7717(); // L: 7604
					var5 = var1.readUnsignedByteNeg(); // L: 7605
					var6 = (var5 >> 4 & 7) + PlayerComposition.field3307; // L: 7606
					var7 = (var5 & 7) + class29.field181; // L: 7607
					var8 = var1.method7714(); // L: 7608
					byte var41 = var1.readByteNeg(); // L: 7609
					var10 = var1.readUnsignedByteSub(); // L: 7610
					byte var42 = var1.readByteSub(); // L: 7611
					var12 = var1.readUnsignedByte() * 4; // L: 7612
					var13 = var1.readUnsignedByteNeg(); // L: 7613
					...
					var3 = var1.readUnsignedByteNeg(); // L: 7630
					var4 = var3 >> 2; // L: 7631
					var5 = var3 & 3; // L: 7632
					var6 = Client.field748[var4]; // L: 7633
					var7 = var1.readUnsignedByteAdd(); // L: 7634
