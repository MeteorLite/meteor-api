...
public final class Client extends GameEngine implements Usernamed, OAuthApi {
	...
	protected final void resizeGame() {
		field601 = class136.getServerTime() + 500L; // L: 4285
	...
	protected final void draw(boolean var1) {
		...
		if ((gameState == 10 || gameState == 20 || gameState == 30) && field601 != 0L && class136.getServerTime() > field601) { // L: 999 1000
	...
	void doCycleJs5() {
		if (gameState != 1000) { // L: 1117
			long var2 = class136.getServerTime(); // L: 1120
			...
			if (--field525 + 1 <= 0) { // L: 1297
				try {
					...
					if (js5ConnectState == 2) { // L: 1310
						...
						KeyHandler.field149 = class136.getServerTime(); // L: 1327
					}
					...
					if (js5ConnectState == 3) { // L: 1329
						...
						} else if (class136.getServerTime() - KeyHandler.field149 > 30000L) { // L: 1339
							...
							if (var15 == null) { // L: 1380
								while (true) {
									...
									if (var15 == null) { // L: 1387
										...
										NetCache.field3982 = class136.getServerTime(); // L: 1411
	...
	final void doCycleLoggedOut() {
		...
		try {
			...
			if (loginState == 5) { // L: 2146
				...
				var40.packetBuffer.writeIntLE(ApproximateRouteStrategy.archive20.hash); // L: 2289
				var40.packetBuffer.writeIntIME(class291.archive14.hash); // L: 2290
				var40.packetBuffer.writeInt(class145.archive8.hash); // L: 2291
				var40.packetBuffer.writeIntIME(class10.archive2.hash); // L: 2292
				var40.packetBuffer.writeIntIME(ObjectSound.archive19.hash); // L: 2293
				var40.packetBuffer.writeIntLE(0); // L: 2294
				...
				var40.packetBuffer.writeIntIME(JagexCache.archive10.hash); // L: 2297
				var40.packetBuffer.writeInt(class166.archive13.hash); // L: 2298
				var40.packetBuffer.writeIntLE(WorldMapRectangle.archive18.hash); // L: 2299
				var40.packetBuffer.writeIntLE(class28.archive15.hash); // L: 2300
				...
				var40.packetBuffer.writeIntLE(BufferedNetSocket.archive3.hash); // L: 2304
				var40.packetBuffer.method7723(UserComparator8.archive1.hash); // L: 2305
				var40.packetBuffer.writeIntLE(class54.archive17.hash); // L: 2306
				var40.packetBuffer.writeIntIME(KeyHandler.archive0.hash); // L: 2307
			...
			if (loginState == 9 && this.field541.method43()) { // L: 2398 2399
				...
				var33.packetBuffer.writeBuffer(this.field496); // L: 2427
		...
		if (hadNetworkError) { // L: 2998
			...
			if (gameState == 30) { // L: 3007
				...
				while (WorldMapID.method4360()) { // L: 3008
					...
					var14.packetBuffer.writeLengthByte(var14.packetBuffer.offset - var2); // L: 3013
				...
				if (timer.field4179) { // L: 3016
					...
					var14.packetBuffer.writeLengthByte(var14.packetBuffer.offset - var2); // L: 3022
				...
				synchronized(class120.mouseRecorder.lock) { // L: 3027
					if (!field490) { // L: 3028
						...
						if (var15 != null) { // L: 3096
							var15.packetBuffer.writeLengthByte(var15.packetBuffer.offset - var3); // L: 3097
				...
				if (MouseHandler.MouseHandler_lastButton == 1 || !GameBuild.mouseCam && MouseHandler.MouseHandler_lastButton == 4 || MouseHandler.MouseHandler_lastButton == 2) { // L: 3116
					...
					var18 = WorldMapSprite.getPacketBufferNode(ClientPacket.BUTTON_CLICK, packetWriter.isaacCipher); // L: 3127
				...
				if (KeyHandler.field118 > 0) { // L: 3133
					...
					long var19 = class136.getServerTime(); // L: 3137
				...
				if (field589 && field588 <= 0) { // L: 3150
					...
					var14.packetBuffer.writeShortAdd(camAngleY); // L: 3155
													...
													do {
														...
														if (var37 == null) { // L: 3339
																...
																if (MouseHandler.MouseHandler_currentButton == 0) { // L: 3360
																	if (field767) { // L: 3361
																		if (class142.dragInventoryWidget == GrandExchangeEvent.hoveredItemContainer && dragItemSlotSource != dragItemSlotDestination) { // L: 3362
																			...
																			var40.packetBuffer.writeShortAddLE(dragItemSlotDestination); // L: 3394
																			var40.packetBuffer.writeShortLE(dragItemSlotSource); // L: 3395
																			var40.packetBuffer.writeIntLE(class142.dragInventoryWidget.id); // L: 3396
																			var40.packetBuffer.writeByteNeg(var30); // L: 3397
															...
															if (Scene.shouldSendWalk()) { // L: 3421
																...
																var40.packetBuffer.writeByteSub(KeyHandler.KeyHandler_pressedKeys[82] ? (KeyHandler.KeyHandler_pressedKeys[81] ? 2 : 1) : 0); // L: 3429
		...
		if (var2 == null) { // L: 6001
			...
			try {
				...
				if (ServerPacket.field3055 == var1.serverPacket) { // L: 6097
					class29.field181 = var3.readUnsignedByteAdd(); // L: 6098
					PlayerComposition.field3307 = var3.readUnsignedByteSub(); // L: 6099
				...
				if (ServerPacket.field3114 == var1.serverPacket) { // L: 6148
					class29.field181 = var3.readUnsignedByteAdd(); // L: 6149
				...
				if (ServerPacket.field3122 == var1.serverPacket) { // L: 6206
					...
					var61 = var3.readUnsignedByteAdd(); // L: 6222
				...
				if (ServerPacket.field3119 == var1.serverPacket) { // L: 6277
					publicChatMode = var3.readUnsignedByteSub(); // L: 6278
					tradeChatMode = var3.readUnsignedByteAdd(); // L: 6279
				...
				if (ServerPacket.field3074 == var1.serverPacket) { // L: 6342
					...
					for (var8 = 0; var8 < var22; ++var8) { // L: 6357
						...
						var62 = var3.readUnsignedByteAdd(); // L: 6359
						if (var62 == 255) { // L: 6360
							var62 = var3.readInt();
						}
				...
				if (ServerPacket.field3121 == var1.serverPacket) { // L: 6557
					var6 = var3.readUnsignedByteNeg(); // L: 6561
				...
				if (ServerPacket.field3083 == var1.serverPacket) { // L: 6605
					...
					var6 = var3.readUnsignedByteAdd(); // L: 6608
				...
				if (ServerPacket.field3102 == var1.serverPacket) { // L: 6789
					...
					var59.packetBuffer.writeIntLE(var5); // L: 6796
					var59.packetBuffer.writeByteSub(GameEngine.fps); // L: 6797
					var59.packetBuffer.writeByteSub(var6); // L: 6798
				...
				if (ServerPacket.field3041 == var1.serverPacket) { // L: 6907
					class29.field181 = var3.readUnsignedByteAdd(); // L: 6908
					PlayerComposition.field3307 = var3.readUnsignedByteSub(); // L: 6909
				...
				if (ServerPacket.field3035 == var1.serverPacket) { // L: 7085
					...
					if (var78) { // L: 7087
						WorldMapID.field2388 = class136.getServerTime() - var3.readLong(); // L: 7088
				...
				if (ServerPacket.field3072 == var1.serverPacket) { // L: 7272
					...
					byte var55 = var3.readByteAdd(); // L: 7274
				...
				if (ServerPacket.field3126 == var1.serverPacket) { // L: 7320
					...
					var13 = var3.readUnsignedByteAdd() * 4; // L: 7345
					byte var10 = var3.readByteAdd(); // L: 7346
					var15 = var3.method7713(); // L: 7347
					int var17 = var3.readUnsignedByte(); // L: 7348
					var33 = var3.readUnsignedByteSub() * 4; // L: 7349
				...
				if (ServerPacket.field3118 == var1.serverPacket) { // L: 7365
					...
					var20 = var3.readUnsignedByteSub(); // L: 7367
					var5 = var3.readUnsignedByteNeg(); // L: 7368
				...
				if (isDraggingWidget) { // L: 11811
					...
					if (draggedOnWidget != null) { // L: 11821
						...
						if (var13 != null) { // L: 11839
							...
							var12.packetBuffer.writeShortAdd(clickedWidget.itemId); // L: 11844
							var12.packetBuffer.writeShort(draggedOnWidget.childIndex); // L: 11845
							var12.packetBuffer.writeShortAddLE(draggedOnWidget.itemId); // L: 11846
