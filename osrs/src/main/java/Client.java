...
public class Client extends JagApplet {
	...
	public void method8(int i) {
		...
		TileDefinition.aClass15Array314 = null;
	...
	public void method26(int x, int y) {
		...
		aClass22_1164.method248(method110(y * 128 + 64, x * 128 + 64, (byte) 9, plane), plane,
	...
	public void method43(byte byte0) {
		...
		for (int j = 0; j < Model.anInt1708; j++) {
			...
			if (k == i)
				continue;
			i = k;
			if (j1 == 2 && aClass22_1164.method271(plane, l, i1, k) >= 0) {
		...
		if (j >= 1 && l >= 1 && j <= 102 && l <= 102) {
			...
			if (k >= 0) {
				...
				if (i3 < 3 && (aByteArrayArrayArray1125[1][j][l] & 2) == 2)
					i3++;
				MapArea.method165(k, i3, j1, l, clippingPlanes[i1], i, j, 0, i1, aClass22_1164,
	...
	public void method51(boolean flag) {
		...
		for (; class50_sub1_sub4_sub2 != null; class50_sub1_sub4_sub2 = (Projectile) aClass6_1282
				.next())
			if (class50_sub1_sub4_sub2.anInt1554 != plane || pulseCycle > class50_sub1_sub4_sub2.anInt1566)
				class50_sub1_sub4_sub2.unlink();
			else if (pulseCycle >= class50_sub1_sub4_sub2.anInt1565) {
					...
					if (class50_sub1_sub4_sub3_sub1 != null
						...
						class50_sub1_sub4_sub2.method562(((Actor) (class50_sub1_sub4_sub3_sub1)).unitX,
								((Actor) (class50_sub1_sub4_sub3_sub1)).unitY, method110(
										...
										- class50_sub1_sub4_sub2.anInt1579, pulseCycle, 0);
				}
				if (class50_sub1_sub4_sub2.anInt1560 < 0) {
	...
	public void method62(JagBuffer class50_sub1_sub2, int i, int j) {
		...
		for (int k = 0; k < updatedPlayerCount; k++) {
			...
			if ((i1 & 0x80) != 0) {
				...
				class50_sub1_sub4_sub3_sub1.method567(pulseCycle, false, j1, j2);
				class50_sub1_sub4_sub3_sub1.anInt1595 = pulseCycle + 300;
			...
			if ((i1 & 0x10) != 0) {
				...
				class50_sub1_sub4_sub3_sub1.method567(pulseCycle, false, i2, l2);
				class50_sub1_sub4_sub3_sub1.anInt1595 = pulseCycle + 300;
				class50_sub1_sub4_sub3_sub1.anInt1596 = class50_sub1_sub2.getByte();
	...
	public void method6() {
		...
		try {
			...
			aClass22_1164 = new SceneGraph(anIntArrayArrayArray891, 104, 4, 104, (byte) 5);
			for (int j = 0; j < 4; j++)
	...
	public void method76(int i) {
		...
		for (Class50_Sub1_Sub4_Sub6 class50_sub1_sub4_sub6 = (Class50_Sub1_Sub4_Sub6) aClass6_1210.first(); class50_sub1_sub4_sub6 != null; class50_sub1_sub4_sub6 = (Class50_Sub1_Sub4_Sub6) aClass6_1210
			...
			else if (pulseCycle >= class50_sub1_sub4_sub6.anInt1740) {
	...
	public void method93(int i) {
		try {
			...
			MapArea class8 = new MapArea(anIntArrayArrayArray891, 14290, aByteArrayArrayArray1125, 104, 104);
			...
			if (!aBoolean1163) {
				...
				for (int j6 = 0; j6 < l2; j6++) {
					...
					if (abyte1 != null) {
						...
						class8.method179(k9, clippingPlanes, l8, -571, aClass22_1164, abyte1);
					}
				}
							...
							if (i10 != -1) {
								...
								for (int l12 = 0; l12 < coordinates.length; l12++) {
									if (coordinates[l12] != k12 || aByteArrayArray1232[l12] == null)
										continue;
									class8.method172(i7, clippingPlanes, aClass22_1164, false,
			...
			outBuffer.putOpcode(40);
			class8.method167(clippingPlanes, anInt1318, aClass22_1164);
			...
			if (l3 < plane - 1)
				l3 = plane - 1;
			if (lowMemory)
				aClass22_1164.method242(MapArea.anInt150, true);
			else
		...
		if (opcode == 59) {
			...
			if (i5 >= 0 && l7 >= 0 && i5 < 104 && l7 < 104) {
				...
				Class50_Sub1_Sub4_Sub6 class50_sub1_sub4_sub6 = new Class50_Sub1_Sub4_Sub6(i5, plane, method110(l7,
						i5, (byte) 9, plane)
						- j13, j15, k10, pulseCycle, l7, 10709);
