									...
									case 1:
										if (ParamComposition.method3596(class326.getWidgetFlags(var9))) { // L: 11396
											...
											if (var22 != null) { // L: 11398
												...
												var23.packetBuffer.writeIntIME(var22[0]); // L: 11400
												var23.packetBuffer.writeShortLE(var9.childIndex); // L: 11401
												var23.packetBuffer.writeIntLE(var22[1]); // L: 11402
												var23.packetBuffer.method7723(var9.method5647()); // L: 11403
												var23.packetBuffer.writeIntLE(var22[2]); // L: 11404
