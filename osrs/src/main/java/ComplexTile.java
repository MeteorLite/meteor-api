public class ComplexTile {
  ...
  public static final int[][] anIntArrayArray426 = {{1, 3, 5, 7},
  ...
  public int anInt416;
  public int anInt417;
  public ComplexTile(int i, int j, int k, int l, int i1, int j1, int k1, int l1,
      int i2, int j2, int l2, int i3, int j3, int k3, int l3, int i4,
      int j4, int k4, int l4) {
    aBoolean413 = l == j3 && l == k && l == i;
    anInt414 = i3;
    anInt415 = l4;
    anInt416 = i4;
    anInt417 = l1;
