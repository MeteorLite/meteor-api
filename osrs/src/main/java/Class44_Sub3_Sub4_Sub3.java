...
public class Class44_Sub3_Sub4_Sub3 extends Renderable {
  ...
  public Class44_Sub3_Sub4_Sub3(int var1, int var2, int var3, int var4, int var5, int var6,
      int var7, int var8, boolean var9, int var10, int var11, int var12) {
  ...
  public Model getModel(boolean var1) {
    ...
    if (var2 == null) {
      ...
      if (this.aClass32_1484.anInt554 != 128 || this.aClass32_1484.anInt555 != 128) {
        var4.method519(9, this.aClass32_1484.anInt554, this.aClass32_1484.anInt554,
            this.aClass32_1484.anInt555);
      }

      var4.method515((byte) -44, this.anInt1505);
      var4.method520(this.aClass32_1484.anInt557 + 64, this.aClass32_1484.anInt558 + 850, -30, -50,
          -30, true);
      return var4;
    }
  }
  ...
  public void method497(int var1, int var2, int var3, byte var4, int var5) {
    ...
    if (!this.aBoolean1495) {
      var6 = var3 - this.anInt1486;
      double var8 = var5 - this.anInt1487;
      ...
      this.aDouble1498 = this.anInt1488;
    }

    var6 = this.anInt1491 + 1 - var1;
    this.aDouble1499 = ((double) var3 - this.aDouble1496) / var6;
    this.aDouble1500 = ((double) var5 - this.aDouble1497) / var6;
    this.aDouble1501 = Math.sqrt(
        this.aDouble1499 * this.aDouble1499 + this.aDouble1500 * this.aDouble1500);
    if (!this.aBoolean1495) {
      this.aDouble1502 = -this.aDouble1501 * Math.tan((double) this.anInt1492 * 0.02454369D);
    }

    this.aDouble1503 =
        2.0D * ((double) var2 - this.aDouble1498 - this.aDouble1502 * var6) / (var6 * var6);
  }
  ...
  public void method498(int var1) {
    ...
    this.aDouble1498 +=
        this.aDouble1502 * (double) var1 + 0.5D * this.aDouble1503 * (double) var1 * (double) var1;
    this.aDouble1502 += this.aDouble1503 * (double) var1;
    this.anInt1504 =
        (int) (Math.atan2(this.aDouble1499, this.aDouble1500) * 325.949D) + 1024 & 2047;
    this.anInt1505 = (int) (Math.atan2(this.aDouble1502, this.aDouble1501) * 325.949D) & 2047;
    if (this.aClass32_1484.aClass26_551 != null) {
      this.anInt1507 += var1;

      while (this.anInt1507 > this.aClass32_1484.aClass26_551.getFrameLength(this.anInt1506,
          41645)) {
