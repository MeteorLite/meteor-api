...
public class Class18 {
    ...
    public void markWall(int i, int j, boolean flag, int k, byte byte0, int l) {
        l -= anInt407;
        k -= anInt408;
        if (byte0 != 25)
            return;
    ...
    public void markSolidOccupant(int i, int j, int k, int l, int i1, boolean flag, int j1) {
        int k1 = 256;
        if (flag)
            k1 += 0x20000;
        j -= anInt407;
    ...
    public void markBlocked(boolean flag, int i, int j) {
        i -= anInt407;
        if (!flag) {
        } else {
            j -= anInt408;
    ...
    public void unmarkWall(byte byte0, int i, boolean flag, int j, int k, int l) {
        l -= anInt407;
        k -= anInt408;
        if (byte0 != 3)
    ...
    public void removeCollisionArea(int i, int j, int k, int l, int i1, boolean flag, int j1) {
        int k1 = 256;
        if (i >= 0)
            return;
        if (flag)
    ...
    public void unmarkHidden(int i, int j, int k) {
        i -= anInt407;
        k -= anInt408;
        if (j != 0)
