...
import static config.Configuration.CACHE_NAME;
...
public final class SignLink implements Runnable {
	...
	public static synchronized boolean playSound(byte[] data, int length) {
		try {
			AudioPlayer.playSound(data);
	...
	public static synchronized void playMidi(byte[] data, int length) {
		AudioPlayer.playSong(data);
	}
