...
public class Class50_Sub1_Sub1_Sub2 extends Rasterizer {
  ...
  public Class50_Sub1_Sub1_Sub2(boolean flag, Archive class2, int i, String s) {
    ...
    aBoolean1508 = false;
    Buffer class50_sub1_sub2 = new Buffer(class2.extract(s + ".dat"));
    Buffer class50_sub1_sub2_1 = new Buffer(class2.extract("index.dat"));
    class50_sub1_sub2_1.offset = class50_sub1_sub2.readUShort() + 4;
    while (i >= 0) {
      aBoolean1496 = !aBoolean1496;
    }
    int k = class50_sub1_sub2_1.readUByte();
    if (k > 0) {
      class50_sub1_sub2_1.offset += 3 * (k - 1);
    }
    for (int l = 0; l < 256; l++) {
      anIntArray1503[l] = class50_sub1_sub2_1.readUByte();
      anIntArray1504[l] = class50_sub1_sub2_1.readUByte();
      int i1 = anIntArray1501[l] = class50_sub1_sub2_1.readUShort();
      int j1 = anIntArray1502[l] = class50_sub1_sub2_1.readUShort();
      int k1 = class50_sub1_sub2_1.readUByte();
      int l1 = i1 * j1;
      aByteArrayArray1500[l] = new byte[l1];
      if (k1 == 0) {
        for (int i2 = 0; i2 < l1; i2++) {
          aByteArrayArray1500[l][i2] = class50_sub1_sub2.readByte();
        }

      } else if (k1 == 1) {
        for (int j2 = 0; j2 < i1; j2++) {
          for (int l2 = 0; l2 < j1; l2++) {
            aByteArrayArray1500[l][j2 + l2 * i1] = class50_sub1_sub2
                .readByte();
          }
  ...
  public void method474(int i, int j, int k, int l, String s) {
    ...
    for (int j1 = 0; j1 < s.length(); j1++) {
      char c = s.charAt(j1);
      if (c != ' ') {
        method481(aByteArrayArray1500[c], j + anIntArray1503[c], l
                + anIntArray1504[c], anIntArray1501[c],
            anIntArray1502[c], k);
      }
      j += anIntArray1505[c];
    }
  ...
  public void method475(int i, byte byte0, int j, String s, int k, int l) {
    ...
    for (int i1 = 0; i1 < s.length(); i1++) {
      ...
      if (c != ' ') {
        method481(
            aByteArrayArray1500[c],
            k + anIntArray1503[c],
            i
                + anIntArray1504[c]
                + (int) (Math.sin((double) i1 / 2D + (double) j
                / 5D) * 5D), anIntArray1501[c],
            anIntArray1502[c], l);
      }
      k += anIntArray1505[c];
    }
    ...
    for (int j1 = 0; j1 < s.length(); j1++) {
      ...
      if (c != ' ') {
        method481(
            ...
            k
                + anIntArray1503[c]
                + (int) (Math.sin((double) j1 / 5D + (double) l
                / 5D) * 5D),
            i
                + anIntArray1504[c]
                + (int) (Math.sin((double) j1 / 3D + (double) l
                / 5D) * 5D), anIntArray1501[c],
            anIntArray1502[c], j);
      }
      k += anIntArray1505[c];
    ...
    for (int l1 = 0; l1 < s.length(); l1++) {
      ...
      if (c != ' ') {
        method481(
            ...
            l
                + anIntArray1504[c]
                + (int) (Math.sin((double) l1 / 1.5D
                + (double) j1) * d), anIntArray1501[c],
            anIntArray1502[c], j);
      }
      k += anIntArray1505[c];
    }
  ...
  public void method478(int i, int j, int k, boolean flag, String s, int l) {
    ...
    for (int j1 = 0; j1 < s.length(); j1++) {
      if (s.charAt(j1) == '@' && j1 + 4 < s.length()
        ...
        if (c != ' ') {
          if (flag) {
            method481(aByteArrayArray1500[c], j + anIntArray1503[c]
                    + 1, k + anIntArray1504[c] + 1,
                anIntArray1501[c], anIntArray1502[c], 0);
          }
          method481(aByteArrayArray1500[c], j + anIntArray1503[c], k
                  + anIntArray1504[c], anIntArray1501[c],
              anIntArray1502[c], i);
        }
        j += anIntArray1505[c];
    ...
    if (aBoolean1508) {
      Rasterizer.method452(i1, 0x800000, k
              + (int) ((double) anInt1506 * 0.69999999999999996D),
          j - i1, true);
    }
  }

  public void method479(boolean flag, int i, int j, int k, int l, String s,
      int i1) {
    if (s == null) {
      return;
    }
    ...
    for (int k1 = 0; k1 < s.length(); k1++) {
      if (s.charAt(k1) == '@' && k1 + 4 < s.length()
        ...
        if (c != ' ') {
          if (flag) {
            method483(j + anIntArray1503[c] + 1, true, 0,
                aByteArrayArray1500[c], l + anIntArray1504[c]
                    + 1, anIntArray1502[c],
                anIntArray1501[c], 192);
          }
          method483(j + anIntArray1503[c], true, k,
              aByteArrayArray1500[c], l + anIntArray1504[c],
  ...
  public void method481(byte[] abyte0, int i, int j, int k, int l, int i1) {
    ...
    if (k <= 0 || l <= 0) {
      ...
      method482(Rasterizer.anIntArray1424, abyte0, i1, i2, j1, k,
          l, k1, l1);
    }
  }

  public void method482(int[] ai, byte[] abyte0, int i, int j, int k, int l,
  ...
  public void method483(int i, boolean flag, int j, byte[] abyte0, int k,
      int l, int i1, int j1) {
    ...
    if (i1 <= 0 || l <= 0) {
      ...
      method484(j2, l1, i2, k1, j1, Rasterizer.anIntArray1424, j,
          2, l, i1, abyte0);
    }
  }
  ...
  public void method484(int i, int j, int k, int l, int i1, int[] ai, int j1,
    ...
    j1 = ((j1 & 0xff00ff) * i1 & 0xff00ff00)
        + ((j1 & 0xff00) * i1 & 0xff0000) >> 8;
    i1 = 256 - i1;
    for (int j2 = -l1; j2 < 0; j2++) {
      for (int k2 = -i2; k2 < 0; k2++) {
        if (abyte0[i++] != 0) {
          int l2 = ai[l];
          ai[l++] = (((l2 & 0xff00ff) * i1 & 0xff00ff00)
              + ((l2 & 0xff00) * i1 & 0xff0000) >> 8)
              + j1;
        } else {
          l++;
        }
