public class Class2 {
	...
	public float method153(byte var1, float var2) {
		float var3 = 32.7032F * (float)Math.pow(2.0D, (double)var2);
		return var3 * 3.141593F / 11025.0F;
	}

	public float method152(int var1, int var2, int var3, float var4) {
		float var5 = (float)this.anIntArrayArrayArray57[var3][0][var1] + var4 * (float)(this.anIntArrayArrayArray57[var3][1][var1] - this.anIntArrayArrayArray57[var3][0][var1]);
		var2 = 49 / var2;
		var5 *= 0.001525879F;
	...
	public float method154(byte var1, int var2, int var3, float var4) {
		float var5 = (float)this.anIntArrayArrayArray56[var2][0][var3] + var4 * (float)(this.anIntArrayArrayArray56[var2][1][var3] - this.anIntArrayArrayArray56[var2][0][var3]);
	...
	public int method155(int var1, float var2, byte var3) {
		...
		float var4;
		if (var1 == 0) {
			var4 = (float)this.anIntArray58[0] + (float)(this.anIntArray58[1] - this.anIntArray58[0]) * var2;
			var4 *= 0.003051758F;
			aFloat61 = (float)Math.pow(0.1D, (double)(var4 / 20.0F));
		...
		if (this.anIntArray55[var1] == 0) {
			...
			aFloatArrayArray59[var1][0] = -2.0F * var4 * (float)Math.cos((double)this.method154((byte)1, var1, 0, var2));
			...
			for (var5 = 1; var5 < this.anIntArray55[var1]; ++var5) {
				...
				float var7 = -2.0F * var6 * (float)Math.cos((double)this.method154((byte)1, var1, var5, var2));
				float var8 = var6 * var6;
				aFloatArrayArray59[var1][var5 * 2 + 1] = aFloatArrayArray59[var1][var5 * 2 - 1] * var8;
				aFloatArrayArray59[var1][var5 * 2] = aFloatArrayArray59[var1][var5 * 2 - 1] * var7 + aFloatArrayArray59[var1][var5 * 2 - 2] * var8;

				for (int var9 = var5 * 2 - 1; var9 >= 2; --var9) {
					var10000 = aFloatArrayArray59[var1];
					var10000[var9] += aFloatArrayArray59[var1][var9 - 1] * var7 + aFloatArrayArray59[var1][var9 - 2] * var8;
				}
