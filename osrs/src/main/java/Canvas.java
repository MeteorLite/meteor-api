public class Canvas extends Rasterizer {
  ...
  static {
    ...
    for (int k = 0; k < 2048; k++) {
      anIntArray1536[k] = (int) (65536D * Math
          .sin((double) k * 0.0030679614999999999D));
      anIntArray1537[k] = (int) (65536D * Math
  ...
  public static void method493() {
    anIntArray1538 = new int[Rasterizer.anInt1426];
    for (int j = 0; j < Rasterizer.anInt1426; j++) {
      anIntArray1538[j] = Rasterizer.anInt1425 * j;
    }

    anInt1532 = Rasterizer.anInt1425 / 2;
    anInt1533 = Rasterizer.anInt1426 / 2;
  }
  ...
  public static void method497(Archive archive) {
    anInt1539 = 0;
    for (int k = 0; k < 50; k++) {
      try {
        aClass50_Sub1_Sub1_Sub3Array1540[k] = new IndexedImage(
            archive, String.valueOf(k), 0);
        if (aBoolean1527
            && aClass50_Sub1_Sub1_Sub3Array1540[k].anInt1522 == 128) {
  ...
  public static int[] method500(int i) {
    ...
    if (anInt1543 > 0) {
      ...
      for (int l = 0; l < anInt1539; l++) {
        if (anIntArrayArray1545[l] != null
            && (anIntArray1546[l] < j || k == -1)) {
          j = anIntArray1546[l];
          k = l;
        }
      }
      ...
      if (class50_sub1_sub1_sub3.anInt1518 == 64) {
        for (int j1 = 0; j1 < 128; j1++) {
          for (int j2 = 0; j2 < 128; j2++) {
            ai[j2 + (j1 << 7)] = ai1[class50_sub1_sub1_sub3.aByteArray1516[(j2 >> 1)
                + (j1 >> 1 << 6)]];
          }
  ...
  public static void updateBrightness(double d, byte byte0) {
  ...
  public static void method503(int i, int j, int k, int l, int i1, int j1,
    ...
    if (i <= j && i <= k) {
      ...
      if (j < k) {
        ...
        if (i != j && j3 < j2 || i == j && j3 > l2) {
          k -= j;
          j -= i;
          for (i = anIntArray1538[i]; --j >= 0; i += Rasterizer.anInt1425) {
            method504(Rasterizer.anIntArray1424, i, 0, 0, j1 >> 16,
                l >> 16, i2 >> 7, k1 >> 7);
            j1 += j3;
            l += j2;
            i2 += k3;
        ...
        j -= i;
        for (i = anIntArray1538[i]; --j >= 0; i += Rasterizer.anInt1425) {
          method504(Rasterizer.anIntArray1424, i, 0, 0, l >> 16,
              j1 >> 16, k1 >> 7, i2 >> 7);
          j1 += j3;
          l += j2;
          i2 += k3;
        ...
        while (--k >= 0) {
          method504(Rasterizer.anIntArray1424, i, 0, 0, i1 >> 16,
              j1 >> 16, l1 >> 7, i2 >> 7);
          j1 += j3;
          i1 += l2;
          i2 += k3;
      ...
      if (i != k && j3 < j2 || i == k && l2 > j2) {
        j -= k;
        k -= i;
        for (i = anIntArray1538[i]; --k >= 0; i += Rasterizer.anInt1425) {
          method504(Rasterizer.anIntArray1424, i, 0, 0, i1 >> 16,
              l >> 16, l1 >> 7, k1 >> 7);
          i1 += j3;
          l += j2;
    ...
    if (j <= k) {
      ...
      if (k < i) {
        ...
        if (j != k && j2 < l2 || j == k && j2 > j3) {
          i -= k;
          k -= j;
          for (j = anIntArray1538[j]; --k >= 0; j += Rasterizer.anInt1425) {
            method504(Rasterizer.anIntArray1424, j, 0, 0, l >> 16,
                i1 >> 16, k1 >> 7, l1 >> 7);
            l += j2;
            i1 += l2;
            k1 += k2;
        ...
        k -= j;
        for (j = anIntArray1538[j]; --k >= 0; j += Rasterizer.anInt1425) {
          method504(Rasterizer.anIntArray1424, j, 0, 0, i1 >> 16,
              l >> 16, l1 >> 7, k1 >> 7);
          l += j2;
          i1 += l2;
          k1 += k2;
        ...
        while (--i >= 0) {
          method504(Rasterizer.anIntArray1424, j, 0, 0, j1 >> 16,
              l >> 16, i2 >> 7, k1 >> 7);
          l += j2;
          j1 += j3;
          k1 += k2;
      ...
      if (j2 < l2) {
        k -= i;
        i -= j;
        for (j = anIntArray1538[j]; --i >= 0; j += Rasterizer.anInt1425) {
          method504(Rasterizer.anIntArray1424, j, 0, 0, j1 >> 16,
              i1 >> 16, i2 >> 7, l1 >> 7);
          j1 += j2;
          i1 += l2;
    ...
    if (i < j) {
      ...
      if (l2 < j3) {
        j -= i;
        i -= k;
        for (k = anIntArray1538[k]; --i >= 0; k += Rasterizer.anInt1425) {
          method504(Rasterizer.anIntArray1424, k, 0, 0, i1 >> 16,
              j1 >> 16, l1 >> 7, i2 >> 7);
          i1 += l2;
          j1 += j3;
          l1 += i3;
      ...
      i -= k;
      for (k = anIntArray1538[k]; --i >= 0; k += Rasterizer.anInt1425) {
        method504(Rasterizer.anIntArray1424, k, 0, 0, j1 >> 16,
            i1 >> 16, i2 >> 7, l1 >> 7);
        i1 += l2;
        j1 += j3;
        l1 += i3;
      ...
      while (--j >= 0) {
        method504(Rasterizer.anIntArray1424, k, 0, 0, l >> 16,
            i1 >> 16, k1 >> 7, l1 >> 7);
        i1 += l2;
        l += j2;
        l1 += i3;
    ...
    if (l2 < j3) {
      i -= j;
      j -= k;
      for (k = anIntArray1538[k]; --j >= 0; k += Rasterizer.anInt1425) {
        method504(Rasterizer.anIntArray1424, k, 0, 0, l >> 16,
            j1 >> 16, k1 >> 7, i2 >> 7);
        l += l2;
        j1 += j3;
    ...
    j -= k;
    for (k = anIntArray1538[k]; --j >= 0; k += Rasterizer.anInt1425) {
      method504(Rasterizer.anIntArray1424, k, 0, 0, j1 >> 16, l >> 16,
          i2 >> 7, k1 >> 7);
      l += l2;
      j1 += j3;
      k1 += i3;
    ...
    while (--i >= 0) {
      method504(Rasterizer.anIntArray1424, k, 0, 0, j1 >> 16, i1 >> 16,
          i2 >> 7, l1 >> 7);
      i1 += j2;
      j1 += j3;
      l1 += k2;
  ...
  public static void method504(int[] ai, int i, int j, int k, int l, int i1,
      int j1, int k1) {
    if (aBoolean1530) {
      int l1;
      if (aBoolean1528) {
  ...
  public static void method505(int i, int j, int k, int l, int i1, int j1,
      int k1) {
    int l1 = 0;
    if (j != i) {
      l1 = (i1 - l << 16) / (j - i);
    ...
    if (i <= j && i <= k) {
      ...
      if (j < k) {
        ...
        if (i != j && j2 < l1 || i == j && j2 > i2) {
          ...
          j -= i;
          for (i = anIntArray1538[i]; --j >= 0; i += Rasterizer.anInt1425) {
            method506(Rasterizer.anIntArray1424, i, k1, 0,
                j1 >> 16, l >> 16);
            j1 += j2;
            l += l1;
          }
        ...
        j -= i;
        for (i = anIntArray1538[i]; --j >= 0; i += Rasterizer.anInt1425) {
          method506(Rasterizer.anIntArray1424, i, k1, 0, l >> 16,
              j1 >> 16);
          j1 += j2;
          l += l1;
        }
        ...
        while (--k >= 0) {
          method506(Rasterizer.anIntArray1424, i, k1, 0, i1 >> 16,
              j1 >> 16);
          j1 += j2;
          i1 += i2;
          i += Rasterizer.anInt1425;
      ...
      if (i != k && j2 < l1 || i == k && i2 > l1) {
        ...
        while (--j >= 0) {
          method506(Rasterizer.anIntArray1424, i, k1, 0, j1 >> 16,
              l >> 16);
          j1 += i2;
          l += l1;
          i += Rasterizer.anInt1425;
    ...
    if (j <= k) {
      ...
      if (k < i) {
        ...
        if (j != k && l1 < i2 || j == k && l1 > j2) {
          ...
          k -= j;
          for (j = anIntArray1538[j]; --k >= 0; j += Rasterizer.anInt1425) {
            method506(Rasterizer.anIntArray1424, j, k1, 0, l >> 16,
                i1 >> 16);
            l += l1;
            i1 += i2;
          }
        ...
        k -= j;
        for (j = anIntArray1538[j]; --k >= 0; j += Rasterizer.anInt1425) {
          method506(Rasterizer.anIntArray1424, j, k1, 0, i1 >> 16,
              l >> 16);
          l += l1;
          i1 += i2;
        }
        ...
        while (--i >= 0) {
          method506(Rasterizer.anIntArray1424, j, k1, 0, j1 >> 16,
              l >> 16);
          l += l1;
          j1 += j2;
          j += Rasterizer.anInt1425;
    ...
    if (i < j) {
      ...
      if (i2 < j2) {
        ...
        i -= k;
        for (k = anIntArray1538[k]; --i >= 0; k += Rasterizer.anInt1425) {
          method506(Rasterizer.anIntArray1424, k, k1, 0, i1 >> 16,
              j1 >> 16);
          i1 += i2;
          j1 += j2;
        }
      ...
      i -= k;
      for (k = anIntArray1538[k]; --i >= 0; k += Rasterizer.anInt1425) {
        method506(Rasterizer.anIntArray1424, k, k1, 0, j1 >> 16,
            i1 >> 16);
        i1 += i2;
        j1 += j2;
      }
      ...
      while (--j >= 0) {
        method506(Rasterizer.anIntArray1424, k, k1, 0, l >> 16,
            i1 >> 16);
        i1 += i2;
        l += l1;
        k += Rasterizer.anInt1425;
    ...
    j -= k;
    for (k = anIntArray1538[k]; --j >= 0; k += Rasterizer.anInt1425) {
      method506(Rasterizer.anIntArray1424, k, k1, 0, j1 >> 16, l >> 16);
      l += i2;
      j1 += j2;
    }

    while (--i >= 0) {
      method506(Rasterizer.anIntArray1424, k, k1, 0, j1 >> 16, i1 >> 16);
      i1 += l1;
      j1 += j2;
      k += Rasterizer.anInt1425;
    }
  ...
  public static void method507(int i, int j, int k, int l, int i1, int j1,
    ...
    if (i <= j && i <= k) {
      ...
      if (j < k) {
        ...
        if (i != j && i8 < i7 || i == j && i8 > k7) {
          ...
          i = anIntArray1538[i];
          while (--j >= 0) {
            method508(Rasterizer.anIntArray1424, ai, 0, 0, i,
        ...
        i = anIntArray1538[i];
        while (--j >= 0) {
          method508(Rasterizer.anIntArray1424, ai, 0, 0, i, l >> 16,
        ...
        while (--k >= 0) {
          method508(Rasterizer.anIntArray1424, ai, 0, 0, i, i1 >> 16,
      ...
      if (i != k && i8 < i7 || i == k && k7 > i7) {
        ...
        while (--j >= 0) {
          method508(Rasterizer.anIntArray1424, ai, 0, 0, i, j1 >> 16,
    ...
    if (j <= k) {
      ...
      if (k < i) {
        ...
        if (j != k && i7 < k7 || j == k && i7 > i8) {
          ...
          j = anIntArray1538[j];
          while (--k >= 0) {
            method508(Rasterizer.anIntArray1424, ai, 0, 0, j,
        ...
        j = anIntArray1538[j];
        while (--k >= 0) {
          method508(Rasterizer.anIntArray1424, ai, 0, 0, j, i1 >> 16,
              l >> 16, l1 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
          l += i7;
          i1 += k7;
          k1 += j7;
        ...
        while (--i >= 0) {
          method508(Rasterizer.anIntArray1424, ai, 0, 0, j, j1 >> 16,
              l >> 16, i2 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
          l += i7;
          j1 += i8;
          k1 += j7;
      ...
      if (i7 < k7) {
        ...
        while (--k >= 0) {
          method508(Rasterizer.anIntArray1424, ai, 0, 0, j, l >> 16,
              i1 >> 16, k1 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
          l += i8;
          i1 += k7;
          k1 += j8;
    ...
    if (i < j) {
      ...
      if (k7 < i8) {
        ...
        k = anIntArray1538[k];
        while (--i >= 0) {
          method508(Rasterizer.anIntArray1424, ai, 0, 0, k, i1 >> 16,
              j1 >> 16, l1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
          i1 += k7;
          j1 += i8;
          l1 += l7;
      ...
      k = anIntArray1538[k];
      while (--i >= 0) {
        method508(Rasterizer.anIntArray1424, ai, 0, 0, k, j1 >> 16,
            i1 >> 16, i2 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
        i1 += k7;
        j1 += i8;
        l1 += l7;
      ...
      while (--j >= 0) {
        method508(Rasterizer.anIntArray1424, ai, 0, 0, k, l >> 16,
            i1 >> 16, k1 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
        i1 += k7;
        l += i7;
        l1 += l7;
  ...
  public static void method508(int[] ai, int[] ai1, int i, int j, int k,
