...
public class ImageRGB extends Rasterizer {
  ...
  public ImageRGB(byte[] abyte0, Component component) {
    ...
    try {
      ...
      PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0,
          anInt1490, anInt1491, anIntArray1489, 0, anInt1490);
      pixelgrabber.grabPixels();
    } catch (Exception _ex) {
      System.out.println("Error converting jpg");
    }
  }
  public ImageRGB(Archive archive, String s, int i) {
    anInt1477 = -235;
    aBoolean1478 = true;
    aByte1479 = 5;
    anInt1480 = -3539;
    ...
    aBoolean1487 = true;
    anInt1488 = 3600;
    Buffer class50_sub1_sub2 = new Buffer(archive.extract(s + ".dat"));
    Buffer class50_sub1_sub2_1 = new Buffer(archive.extract("index.dat"));
    class50_sub1_sub2_1.offset = class50_sub1_sub2.readUShort();
    anInt1494 = class50_sub1_sub2_1.readUShort();
    anInt1495 = class50_sub1_sub2_1.readUShort();
    int j = class50_sub1_sub2_1.readUByte();
    int[] ai = new int[j];
    for (int k = 0; k < j - 1; k++) {
    ...
    for (int l = 0; l < i; l++) {
      ...
      class50_sub1_sub2.offset += class50_sub1_sub2_1.readUShort()
          * class50_sub1_sub2_1.readUShort();
      class50_sub1_sub2_1.offset++;
    }

    anInt1492 = class50_sub1_sub2_1.readUByte();
    anInt1493 = class50_sub1_sub2_1.readUByte();
    anInt1490 = class50_sub1_sub2_1.readUShort();
    anInt1491 = class50_sub1_sub2_1.readUShort();
    int i1 = class50_sub1_sub2_1.readUByte();
    int j1 = anInt1490 * anInt1491;
    anIntArray1489 = new int[j1];
    if (i1 == 0) {
      for (int k1 = 0; k1 < j1; k1++) {
        anIntArray1489[k1] = ai[class50_sub1_sub2.readUByte()];
      }
    ...
    if (i1 == 1) {
      for (int l1 = 0; l1 < anInt1490; l1++) {
        for (int i2 = 0; i2 < anInt1491; i2++) {
          anIntArray1489[l1 + i2 * anInt1490] = ai[class50_sub1_sub2
              .readUByte()];
        }
  ...
  public void method456(boolean flag) {
    if (flag) {
      ...
      Rasterizer.method444(anInt1490, anInt1491, anIntArray1489);
    }
  }
  ...
  public void method458(int i) {
    ...
    for (int j = 0; j < anInt1491; j++) {
      for (int k = 0; k < anInt1490; k++) {
        ai[(j + anInt1493) * anInt1494 + k + anInt1492] = anIntArray1489[j
            * anInt1490 + k];
      }
  ...
  public void method459(int i, int j, int k) {
    ...
    method460(k1, l1, j1, anIntArray1489, i1, i2, l, (byte) -39,
        Rasterizer.anIntArray1424);
    if (j >= 0) {
      aBoolean1487 = !aBoolean1487;
    }
  }
  ...
  public void method461(int i, int j, int k) {
    ...
    if (k1 <= 0 || j1 <= 0) {
      ...
      method462(Rasterizer.anIntArray1424, anIntArray1489, 0, i1,
          l, k1, j1, l1, i2);
    }
  }

  public void method462(int[] ai, int[] ai1, int i, int j, int k, int l,
  ...
  public void method463(int i, int j, int k, int l) {
    ...
    if (l1 <= 0 || k1 <= 0) {
      ...
      method464(l1, j2, 0, i2, j1, l, i1, k1, Rasterizer.anIntArray1424,
          anIntArray1489);
    }
  }

  public void method464(int i, int j, int k, int l, int i1, int k1, int l1,
      int i2, int[] ai, int[] ai1) {
    int j2 = 256 - k1;
  ...
  public void method465(int i, int j, int k, int l, int i1, int[] ai, int j1,
    ...
    try {
      ...
      for (i = 0; i < k; i++) {
        ...
        int l4 = k3 - l2 * i4;
        for (j1 = -ai[i]; j1 < 0; j1++) {
          Rasterizer.anIntArray1424[j4++] = anIntArray1489[(k4 >> 16)
              + (l4 >> 16) * anInt1490];
          k4 += i3;
          l4 -= l2;
        }
  ...
  public void method467(IndexedImage class50_sub1_sub1_sub3, int i,
      int j, int k) {
    if (j != -49993) {
      return;
    }
    ...
    if (k1 <= 0 || j1 <= 0) {
      ...
      method468(l, l1, anIntArray1489, k1,
          Rasterizer.anIntArray1424,
          class50_sub1_sub1_sub3.aByteArray1516, 40303, j1, i1, 0, i2);
    }
  }

  public void method468(int i, int j, int[] ai, int k, int[] ai1,
      byte[] abyte0, int l, int i1, int j1, int k1, int l1) {
    int i2 = -(k >> 2);
    if (l != 40303) {
