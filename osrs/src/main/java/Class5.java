...
public class Class5 {
  ...
  public Model method184(int var1, int var2) {
    Model var3 = (Model) aClass39_165.method339((var1 << 16) + var2);
    if (var3 != null) {
      return var3;
    } else {
      if (var1 == 1) {
      ...
      if (var3 != null) {
        aClass39_165.method340(201, (var1 << 16) + var2, var3);
      }
  ...
  public Model method183(int var1, int var2, int var3, boolean var4) {
    ...
    if (var5 == null) {
      ...
      Model var6 = new Model(true, Class11.method211(var1) & Class11.method211(var2), var5, true,
          false);
      if (var1 != -1 || var2 != -1) {
        var6.method510();
      }
  ...
  public static void method185(int var0, int var1, Model var2, int var3) {
    ...
    if (var2 != null && var3 != 4) {
      aClass39_165.method340(201, (var3 << 16) + var1, var2);
    }
  ...
  public static void method181(Class47 var0, Class47 var1, Class44_Sub3_Sub1_Sub4[] var2) {
    ...
    Buffer var3 = new Buffer(var0.method546("data", null), (byte) 1);
    int var4 = -1;
    int var5 = var3.readUShort();
    ...
    while (true) {
      ...
      do {
        ...
        int var6 = var3.readUShort();
        if (var6 == 65535) {
          var4 = var3.readUShort();
        ...
        var7.anInt108 = var6;
        var7.anInt109 = var4;
        var7.anInt110 = var3.readUByte();
        var7.anInt111 = var3.readUByte();
        var7.anInt112 = var3.readUShort();
        var7.anInt113 = var3.readUShort();
        var7.anInt114 = var3.readUShort();
        var7.aByte115 = (byte) var3.readUByte();
        var7.anInt121 = var3.readUByte();
        if (var7.anInt121 != 0) {
          var7.anInt121 = (var7.anInt121 - 1 << 8) + var3.readUByte();
        } else {
          var7.anInt121 = -1;
        }

        int var8 = var3.readUByte();
        int var9;
        if (var8 > 0) {
          ...
          for (var9 = 0; var9 < var8; ++var9) {
            var7.anIntArray119[var9] = var3.readUByte();
            var7.anIntArray120[var9] = var3.readUShort();
          }
        }
        ...
        if (var9 > 0) {
          ...
          for (var10 = 0; var10 < var9; ++var10) {
            ...
            for (int var12 = 0; var12 < var11; ++var12) {
              var7.anIntArrayArray118[var10][var12] = var3.readUShort();
            }
          }
        }

        if (var7.anInt110 == 0) {
          var7.anInt122 = var3.readUShort();
          var7.aBoolean124 = var3.readUByte() == 1;
          ...
          for (var11 = 0; var11 < var10; ++var11) {
            var7.anIntArray125[var11] = var3.readUShort();
            var7.anIntArray126[var11] = var3.readShort();
            var7.anIntArray127[var11] = var3.readShort();
          }
        }

        if (var7.anInt110 == 1) {
          var7.anInt128 = var3.readUShort();
          var7.aBoolean129 = var3.readUByte() == 1;
        }

        if (var7.anInt110 == 2) {
          var7.anIntArray104 = new int[var7.anInt113 * var7.anInt114];
          var7.anIntArray105 = new int[var7.anInt113 * var7.anInt114];
          var7.aBoolean130 = var3.readUByte() == 1;
          var7.aBoolean131 = var3.readUByte() == 1;
          var7.aBoolean132 = var3.readUByte() == 1;
          var7.aBoolean133 = var3.readUByte() == 1;
          var7.anInt134 = var3.readUByte();
          var7.anInt135 = var3.readUByte();
          ...
          for (var10 = 0; var10 < 20; ++var10) {
            ...
            if (var11 == 1) {
              var7.anIntArray137[var10] = var3.readShort();
              var7.anIntArray138[var10] = var3.readShort();
              String var14 = var3.readString();
              if (var1 != null && var14.length() > 0) {
                int var13 = var14.lastIndexOf(",");
                var7.aClass44_Sub3_Sub1_Sub2Array136[var10] = method186(
                    Integer.parseInt(var14.substring(var13 + 1)), true, var14.substring(0, var13),
                    var1);
              }
            }
          }
          ...
          for (var10 = 0; var10 < 5; ++var10) {
            var7.aStringArray139[var10] = var3.readString();
        ...
        if (var7.anInt110 == 3) {
          var7.aBoolean140 = var3.readUByte() == 1;
        }

        if (var7.anInt110 == 4 || var7.anInt110 == 1) {
          var7.aBoolean141 = var3.readUByte() == 1;
          var10 = var3.readUByte();
          if (var2 != null) {
            var7.aClass44_Sub3_Sub1_Sub4_143 = var2[var10];
          }

          var7.aBoolean142 = var3.readUByte() == 1;
        }

        if (var7.anInt110 == 4) {
          var7.aString144 = var3.readString();
          var7.aString145 = var3.readString();
        }

        if (var7.anInt110 == 1 || var7.anInt110 == 3 || var7.anInt110 == 4) {
          var7.anInt146 = var3.readInt();
        }

        if (var7.anInt110 == 3 || var7.anInt110 == 4) {
          var7.anInt147 = var3.readInt();
          var7.anInt148 = var3.readInt();
          var7.anInt149 = var3.readInt();
        }

        if (var7.anInt110 == 5) {
          String var15 = var3.readString();
          if (var1 != null && var15.length() > 0) {
            var11 = var15.lastIndexOf(",");
            var7.aClass44_Sub3_Sub1_Sub2_150 = method186(
                Integer.parseInt(var15.substring(var11 + 1)), true, var15.substring(0, var11),
                var1);
          }

          var15 = var3.readString();
          if (var1 != null && var15.length() > 0) {
            var11 = var15.lastIndexOf(",");
            var7.aClass44_Sub3_Sub1_Sub2_151 = method186(
                Integer.parseInt(var15.substring(var11 + 1)), true, var15.substring(0, var11),
                var1);
          }
        }
        ...
        if (var7.anInt110 == 6) {
          ...
          if (var10 != 0) {
            var7.anInt152 = 1;
            var7.anInt153 = (var10 - 1 << 8) + var3.readUByte();
          }

          var10 = var3.readUByte();
          if (var10 != 0) {
            var7.anInt154 = 1;
            var7.anInt155 = (var10 - 1 << 8) + var3.readUByte();
          }

          var10 = var3.readUByte();
          if (var10 != 0) {
            var7.anInt156 = (var10 - 1 << 8) + var3.readUByte();
          } else {
            var7.anInt156 = -1;
          }
          ...
          var10 = var3.readUByte();
          if (var10 != 0) {
            var7.anInt157 = (var10 - 1 << 8) + var3.readUByte();
          } else {
            var7.anInt157 = -1;
          }

          var7.anInt158 = var3.readUShort();
          var7.anInt159 = var3.readUShort();
          var7.anInt160 = var3.readUShort();
        }
        ...
        if (var7.anInt110 == 7) {
          ...
          var7.aBoolean142 = var3.readUByte() == 1;
          var7.anInt146 = var3.readInt();
          var7.anInt134 = var3.readShort();
          var7.anInt135 = var3.readShort();
          var7.aBoolean131 = var3.readUByte() == 1;
          var7.aStringArray139 = new String[5];

          for (var11 = 0; var11 < 5; ++var11) {
            var7.aStringArray139[var11] = var3.readString();
        ...
        if (var7.anInt111 == 2 || var7.anInt110 == 2) {
          var7.aString161 = var3.readString();
          var7.aString162 = var3.readString();
          var7.anInt163 = var3.readUShort();
        }
      } while (var7.anInt111 != 1 && var7.anInt111 != 4 && var7.anInt111 != 5
          && var7.anInt111 != 6);

      var7.aString164 = var3.readString();
  ...
  public static Class44_Sub3_Sub1_Sub2 method186(int var0, boolean var1, String var2,
      Class47 var3) {
