...
public class Class5 {
    ...
    public static void method185(int i, int j, Model model, int k) {
        aClass39_165.method341();
        if (i != 0)
            anInt102 = 86;
        if (model != null && k != 4)
            aClass39_165.method340(201, (k << 16) + j, model);
    }
    ...
    public Model method183(int i, int j, int k, boolean flag) {
        ...
        Model model;
        if (flag)
            model = method184(anInt154, anInt155);
        else
            model = method184(anInt152, anInt153);
        if (model == null)
            return null;
        if (i == -1 && j == -1 && model.anIntArray1536 == null)
            return model;
        Model model_1 = new Model(true, Class11.method211(i, 0) & Class11.method211(j, 0), model, true, false);
        if (i != -1 || j != -1)
            model_1.method510(9);
        if (i != -1)
            model_1.method511(i, -284);
        if (j != -1)
            model_1.method511(j, -284);
        model_1.method520(64, 768, -50, -10, -50, true);
        return model_1;
    }

    public Model method184(int i, int j) {
        Model model = (Model) aClass39_165.method339((i << 16) + j);
        if (model != null)
            return model;
        if (i == 1)
            model = Model.method503(j, 6);
        if (i == 2)
            model = Class12.method214(j).method217((byte) 0);
        if (i == 3)
            model = Client.aClass44_Sub3_Sub4_Sub6_Sub1_1252.method536(true);
        if (i == 4)
            model = Class14.method220(j).method225((byte) 7, 50);
        if (i == 5)
            model = null;
        if (model != null)
            aClass39_165.method340(201, (i << 16) + j, model);
        return model;
    }
