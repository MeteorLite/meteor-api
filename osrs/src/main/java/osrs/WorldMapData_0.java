...
public class WorldMapData_0 extends AbstractWorldMapData {
	...
	void init(Buffer var1) {
		int var2 = var1.asfjaja(); // L: 9
		if (var2 != WorldMapID.field2773.value) { // L: 10
			throw new IllegalStateException(""); // L: 11
		} else {
			super.minPlane = var1.asfjaja(); // L: 13
			super.planes = var1.asfjaja(); // L: 14
			super.regionXLow = var1.nashfa(); // L: 15
			super.regionYLow = var1.nashfa(); // L: 16
			super.regionX = var1.nashfa(); // L: 17
			super.regionY = var1.nashfa(); // L: 18
