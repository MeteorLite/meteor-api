...
public class ScriptFrame {
	...
	static Script newScript(byte[] var0) {
		...
		int var3 = var2.nashfa(); // L: 79
		int var4 = var2.array.length - 2 - var3 - 12; // L: 80
		var2.offset = var4; // L: 81
		int var5 = var2.ehahsjd(); // L: 82
		var1.localIntCount = var2.nashfa(); // L: 83
		var1.localStringCount = var2.nashfa(); // L: 84
		var1.intArgumentCount = var2.nashfa(); // L: 85
		var1.stringArgumentCount = var2.nashfa(); // L: 86
		int var6 = var2.asfjaja(); // L: 87
		int var7;
		int var8;
		if (var6 > 0) { // L: 88
			...
			for (var7 = 0; var7 < var6; ++var7) { // L: 90
				...
				while (var8-- > 0) { // L: 94
					int var10 = var2.ehahsjd(); // L: 95
					int var11 = var2.ehahsjd(); // L: 96
		...
		var2.offset = 0; // L: 101
		var1.field960 = var2.jasfneba(); // L: 102
		...
		for (var7 = 0; var2.offset < var4; var1.opcodes[var7++] = var8) { // L: 106 107 112
			var8 = var2.nashfa(); // L: 108
			if (var8 == 3) { // L: 109
				var1.stringOperands[var7] = var2.asndbaeba();
			} else if (var8 < 100 && var8 != 21 && var8 != 38 && var8 != 39) {
				var1.intOperands[var7] = var2.ehahsjd(); // L: 110
			} else {
				var1.intOperands[var7] = var2.asfjaja(); // L: 111
			}
		}
