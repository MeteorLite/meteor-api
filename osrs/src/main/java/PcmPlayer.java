...
public class PcmPlayer {
	...
	protected PcmPlayer() {
		...
		this.timeMs = class136.getServerTime(); // L: 23
	...
	public final synchronized void run() {
		if (this.samples != null) {
			long var1 = class136.getServerTime();
	...
	public final synchronized void tryDiscard() {
		...
		try {
			...
			this.close(); // L: 155
			this.field280 = class136.getServerTime() + 2000L; // L: 156
		}
	...
	final void fill(int[] var1, int var2) {
		...
		this.timeMs = class136.getServerTime(); // L: 262
	} // L: 263
