...
public class Messages {
	...
	static void resumePauseWidget(int var0, int var1) {
		PacketBufferNode var2 = ItemContainer.getPacketBufferNode(ClientPacket.RESUME_PAUSEBUTTON, Client.packetWriter.isaacCipher); // L: 9075
		var2.packetBuffer.writeIntIME(var0); // L: 9076
		var2.packetBuffer.writeShortLE(var1); // L: 9077
