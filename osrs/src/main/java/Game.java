...
//        gameGraphics.translate(extraWidth, extraHeight);
        imageProducer = new ImageProducer(width, height, gameFrame);
...
//        gameFrame.pack();
    ...
    public final void initializeApplet(int width, int height) {
        ...
        this.height = height;
        gameGraphics = gameFrame.getGraphics();
        imageProducer = new ImageProducer(this.width, this.height, getParentComponent());
        startRunnable(this, 1);
    }
    ...
    public boolean handleInterfaceScrolling(MouseWheelEvent event, Client client) {
        int rotation = event.getWheelRotation();
