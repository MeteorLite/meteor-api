		...
		for (int var6 = 0; var6 < var2; ++var6) { // L: 9611
			...
			if (var7 != null && var7 != GrandExchangeEvents.localPlayer && var7.username != null && var7.username.equals(var5)) { // L: 9613
				...
				if (var0 == 1) { // L: 9614
					...
					var8.packetBuffer.writeShortLE(var3[var6]); // L: 9617
					var8.packetBuffer.writeByteAdd(0); // L: 9618
					...
					var8.packetBuffer.writeByteNeg(0); // L: 9624
					...
					var8.packetBuffer.writeShortAddLE(var3[var6]); // L: 9631
					...
					var8.packetBuffer.writeByteAdd(0); // L: 9639
