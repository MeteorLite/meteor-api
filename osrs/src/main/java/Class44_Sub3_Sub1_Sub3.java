...
public class Class44_Sub3_Sub1_Sub3 extends Statics {
  ...
  public Class44_Sub3_Sub1_Sub3(Class47 var1, String var2, int var3) {
    ...
    this.anInt1451 = var5.readUShort();
    this.anInt1452 = var5.readUShort();
    int var6 = var5.readUByte();
    this.anIntArray1446 = new int[var6];

    int var7;
    for (var7 = 0; var7 < var6 - 1; ++var7) {
      this.anIntArray1446[var7 + 1] = var5.readMedium();
    }
    ...
    this.anInt1449 = var5.readUByte();
    this.anInt1450 = var5.readUByte();
    this.anInt1447 = var5.readUShort();
    this.anInt1448 = var5.readUShort();
    var7 = var5.readUByte();
    ...
    if (var7 == 0) {
      for (var9 = 0; var9 < var8; ++var9) {
        this.aByteArray1445[var9] = var4.readByte();
      }
      ...
      if (var7 == 1) {
        for (var9 = 0; var9 < this.anInt1447; ++var9) {
          for (int var10 = 0; var10 < this.anInt1448; ++var10) {
            this.aByteArray1445[var9 + var10 * this.anInt1447] = var4.readByte();
          }
        }
      }
  ...
  public void method453(byte var1, int var2, int var3) {
    ...
    if (var7 > 0 && var6 > 0) {
      this.method454(var9, (byte) -55, var8, var5, var6, var7, Statics.anIntArray1351,
          this.aByteArray1445, var4, this.anIntArray1446);
      if (var1 != 7) {
        this.anInt1438 = -485;
      }
  ...
  public void method454(int var1, byte var2, int var3, int var4, int var5, int var6, int[] var7,
      byte[] var8, int var9, int[] var10) {
    int var11 = -(var6 >> 2);
    var6 = -(var6 & 3);
  ...
  public void method449() {
    if (this.anInt1447 != this.anInt1451 || this.anInt1448 != this.anInt1452) {
      ...
      for (int var3 = 0; var3 < this.anInt1448; ++var3) {
        for (int var4 = 0; var4 < this.anInt1447; ++var4) {
          var1[var4 + (var3 + this.anInt1450) * this.anInt1451
              + this.anInt1449] = this.aByteArray1445[var2++];
        }
      }
  ...
  public void method448(byte var1) {
    ...
    for (int var4 = 0; var4 < this.anInt1448; ++var4) {
      for (int var5 = 0; var5 < this.anInt1447; ++var5) {
        var2[(var4 + this.anInt1450 >> 1) * this.anInt1451 + (var5 + this.anInt1449
            >> 1)] = this.aByteArray1445[var3++];
      }
    }
