public class ChatCensor {
  ...
  public static final String[] aStringArray746 = {"cook", "cook's", "cooks",
  ...
  public static void method373(Archive class2) {
    Buffer class50_sub1_sub2 = new Buffer(class2.extract("fragmentsenc.txt"));
    Buffer class50_sub1_sub2_1 = new Buffer(class2.extract("badenc.txt"));
    Buffer class50_sub1_sub2_2 = new Buffer(class2.extract("domainenc.txt"));
    Buffer class50_sub1_sub2_3 = new Buffer(class2.extract("tldlist.txt"));
    method374(class50_sub1_sub2, class50_sub1_sub2_1, class50_sub1_sub2_2,
        class50_sub1_sub2_3);
  }

  public static void method374(Buffer class50_sub1_sub2,
      Buffer class50_sub1_sub2_1,
      Buffer class50_sub1_sub2_2,
  ...
  public static void method375(Buffer class50_sub1_sub2, int i) {
    ...
    for (int k = 0; k < j; k++) {
      anIntArray745[k] = class50_sub1_sub2.readUByte();
      char[] ac = new char[class50_sub1_sub2.readUByte()];
      for (int l = 0; l < ac.length; l++) {
        ac[l] = (char) class50_sub1_sub2.readUByte();
      }
  ...
  public static void method376(boolean flag,
    ...
    if (!flag) {
      ...
      method379(34541, class50_sub1_sub2, aCharArrayArray741,
          aByteArrayArrayArray742);
    }
  }
  ...
  public static void method378(Buffer class50_sub1_sub2, int i) {
    ...
    for (int j = 0; j < anIntArray740.length; j++) {
      anIntArray740[j] = class50_sub1_sub2.readUShort();
    }

  }

  public static void method379(int i, Buffer class50_sub1_sub2,
      char[][] ac, byte[][][] abyte0) {
    for (int j = 0; j < ac.length; j++) {
      char[] ac1 = new char[class50_sub1_sub2.readUByte()];
      for (int k = 0; k < ac1.length; k++) {
        ac1[k] = (char) class50_sub1_sub2.readUByte();
      }

      ac[j] = ac1;
      byte[][] abyte1 = new byte[class50_sub1_sub2.readUByte()][2];
      for (int l = 0; l < abyte1.length; l++) {
        abyte1[l][0] = (byte) class50_sub1_sub2.readUByte();
        abyte1[l][1] = (byte) class50_sub1_sub2.readUByte();
      }
  ...
  public static void method380(Buffer class50_sub1_sub2,
      char[][] ac, int i) {
    if (i != -37125) {
      anInt728 = 218;
    }
  ...
  public static String method383(byte byte0, String s) {
    ...
    method400(3, ac);
    for (String element : aStringArray746) {
      for (int j = -1; (j = s2.indexOf(element, j + 1)) != -1; ) {
        char[] ac1 = element.toCharArray();
  ...
  public static void method386(char[] ac, int i) {
    for (int j = 0; j < 2; j++) {
      for (int k = aCharArrayArray741.length - 1; k >= 0; k--) {
        method395(aByteArrayArrayArray742[k], -939,
            aCharArrayArray741[k], ac);
      }
  ...
  public static void method388(char[] ac, char[] ac1, char[] ac2, int i,
      char[] ac3) {
    if (i >= 0) {
      return;
    }
  ...
  public static void method391(char[] ac, int i) {
    ...
    for (int j = 0; j < aCharArrayArray744.length; j++) {
      method392(ac, (byte) 7, ac1, anIntArray745[j],
          aCharArrayArray744[j], ac3);
    }

  }

  public static void method392(char[] ac, byte byte0, char[] ac1, int i,
      char[] ac2, char[] ac3) {
    ...
    for (int k = 0; k <= ac1.length - ac.length; k += j) {
      ...
      while (l < ac1.length && (!flag2 || !flag3)) {
        ...
        if (i1 < ac.length && (k1 = method398(ac[i1], c, c2, 7)) > 0) {
          ...
          if (k1 == 2
              && (method406(c, false) || method406(c2, false))) {
            flag2 = true;
          }
          l += k1;
          i1++;
      ...
      if (i1 >= ac.length && (!flag2 || !flag3)) {
        ...
        if (!flag1) {
          ...
          boolean flag5 = false;
          boolean flag6 = false;
          if (k - 1 < 0 || method403(ac1[k - 1], false)
              && ac1[k - 1] != '\'') {
            flag5 = true;
          }
          if (l >= ac1.length || method403(ac1[l], false)
              && ac1[l] != '\'') {
            flag6 = true;
          }
          if (!flag5 || !flag6) {
            ...
            for (; !flag7 && k2 < l; k2++) {
              if (k2 >= 0
                  && (!method403(ac1[k2], false) || ac1[k2] == '\'')) {
                char[] ac2 = new char[3];
                int j3;
                for (j3 = 0; j3 < 3; j3++) {
                  if (k2 + j3 >= ac1.length
                      || method403(ac1[k2 + j3], false)
                      && ac1[k2 + j3] != '\'') {
                    break;
                  }
                  ac2[j3] = ac1[k2 + j3];
                ...
                if (j3 < 3
                    && k2 - 1 >= 0
                    && (!method403(ac1[k2 - 1], false) || ac1[k2 - 1] == '\'')) {
                  flag8 = false;
                }
  ...
  public static boolean method396(byte byte0, byte[][] abyte0, byte byte1,
      int i) {
    int j = 0;
    if (i < 4 || i > 4) {
      throw new NullPointerException();
    ...
    do {
      ...
      if (byte1 < abyte0[l][0] || byte1 == abyte0[l][0]
          && byte0 < abyte0[l][1]) {
        k = l;
      } else {
        j = l;
