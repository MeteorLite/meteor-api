public class BZip2Decompressor {
  ...
  public static BZip2Block block = new BZip2Block();

  public static int method312(byte[] abyte0, int i, byte[] abyte1, int j,
      int k) {
    synchronized (block) {
      block.aByteArray47 = abyte1;
      block.anInt48 = k;
  ...
  public static void method314(BZip2Block class1) {
    int k8 = 0;
    int[] ai = null;
    int[] ai1 = null;
    int[] ai2 = null;
    class1.anInt62 = 1;
    if (BZip2Block.anIntArray71 == null) {
      BZip2Block.anIntArray71 = new int[class1.anInt62 * 0x186a0];
    }
    boolean flag19 = true;
    while (flag19) {
      ...
      for (int j = 0; j < 16; j++) {
        ...
        class1.aBooleanArray74[j] = byte1 == 1;
      }
      ...
      for (int l3 = 0; l3 < j4; l3++) {
        ...
        method319(class1.anIntArrayArray81[l3],
            class1.anIntArrayArray82[l3],
            class1.anIntArrayArray83[l3],
      ...
      for (int k5 = ai2[l7 - ai1[i7]]; k5 != l4; ) {
        if (k5 == 0 || k5 == 1) {
          ...
          do {
            ...
            int i8;
            byte byte10;
            for (i8 = method317(j7, class1); i8 > ai[j7]; i8 = i8 << 1
                | byte10) {
              j7++;
          ...
          for (; j6 > 0; j6--) {
            BZip2Block.anIntArray71[i6] = byte5 & 0xff;
            i6++;
          }
          ...
          if (j11 < 16) {
            ...
            for (; j11 > 0; j11--) {
              class1.aByteArray76[j10 + j11] = class1.aByteArray76[j10
                  + j11 - 1];
            }
            ...
            for (; l10 > 0; l10--) {
              class1.anIntArray77[l10]--;
              class1.aByteArray76[class1.anIntArray77[l10]] = class1.aByteArray76[
                  class1.anIntArray77[l10 - 1] + 16 - 1];
            }
            ...
            if (class1.anIntArray77[0] == 0) {
              ...
              for (int k9 = 15; k9 >= 0; k9--) {
                for (int l9 = 15; l9 >= 0; l9--) {
                  class1.aByteArray76[i10] = class1.aByteArray76[class1.anIntArray77[k9]
                      + l9];
                  i10--;
                }
          ...
          BZip2Block.anIntArray71[i6] = class1.aByteArray75[byte6 & 0xff] & 0xff;
          i6++;
          if (j5 == 0) {
            i5++;
            j5 = 50;
          ...
          int j8;
          byte byte11;
          for (j8 = method317(k7, class1); j8 > ai[k7]; j8 = j8 << 1
              | byte11) {
            k7++;
      ...
      System.arraycopy(class1.anIntArray67, 0, class1.anIntArray69, 1, 256);
      ...
      for (int l2 = 0; l2 < i6; l2++) {
        byte byte7 = (byte) (BZip2Block.anIntArray71[l2] & 0xff);
        BZip2Block.anIntArray71[class1.anIntArray69[byte7 & 0xff]] |= l2 << 8;
        class1.anIntArray69[byte7 & 0xff]++;
      }

      class1.anInt65 = BZip2Block.anIntArray71[class1.anInt64] >> 8;
      class1.anInt68 = 0;
      class1.anInt65 = BZip2Block.anIntArray71[class1.anInt65];
      class1.anInt66 = (byte) (class1.anInt65 & 0xff);
      class1.anInt65 >>= 8;
      class1.anInt68++;
      class1.anInt85 = i6;
      method313(class1);
      flag19 = class1.anInt68 == class1.anInt85 + 1 && class1.anInt58 == 0;
    }
  }

  public static byte method315(BZip2Block class1) {
    return (byte) method317(8, class1);
  }

  public static byte method316(BZip2Block class1) {
    return (byte) method317(1, class1);
  }

  public static int method317(int i, BZip2Block class1) {
    int j;
    do {
      if (class1.anInt61 >= i) {
      ...
      class1.anInt60 = class1.anInt60 << 8
          | class1.aByteArray47[class1.anInt48] & 0xff;
      class1.anInt61 += 8;
      class1.anInt48++;
      class1.anInt49--;
      class1.anInt50++;
  ...
  public static void method318(BZip2Block class1) {
    class1.anInt72 = 0;
    for (int i = 0; i < 256; i++) {
  ...
  public static void method319(int[] ai, int[] ai1, int[] ai2, byte[] abyte0,
      int i, int j, int k) {
    int l = 0;
