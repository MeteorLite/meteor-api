...
public class Class14 {
    ...
    public static Class44_Sub3_Sub1_Sub2 method226(int i, int j, int k, int l) {
        ...
        Model model = class14.method224(1);
        if (model == null)
            return null;
        ...
        model.method523(0, class14.anInt333, class14.anInt334, class14.anInt332, class14.anInt335, l3 + model.anInt1394 / 2 + class14.anInt336, i4 + class14.anInt336);
    ...
    public Model method224(int i) {
        ...
        Model model = (Model) aClass39_364.method339(anInt325);
        if (model != null)
            return model;
        model = Model.method503(anInt326, 6);
        if (model == null)
            return null;
        if (anInt359 != 128 || anInt360 != 128 || anInt361 != 128)
            model.method519(9, anInt361, anInt359, anInt360);
        if (anIntArray329 != null) {
            for (int l = 0; l < anIntArray329.length; l++)
                model.method517(anIntArray329[l], anIntArray330[l]);

        }
        model.method520(64 + anInt362, 768 + anInt363, -50, -10, -50, true);
        model.aBoolean1555 = true;
        aClass39_364.method340(201, anInt325, model);
        return model;
    }

    public Model method225(byte byte0, int i) {
        if (anIntArray355 != null && i > 1) {
            int j = -1;
            for (int k = 0; k < 10; k++)
                if (i >= anIntArray356[k] && anIntArray356[k] != 0)
        ...
        Model model = Model.method503(anInt326, 6);
        if (byte0 == 7)
            byte0 = 0;
        else
            throw new NullPointerException();
    ...
    public boolean method227(int i, int j) {
        ...
        if (k == -1)
            return true;
        boolean flag = Model.method504(k);
        if (l != -1 && !Model.method504(l))
            flag = false;
        if (i1 != -1 && !Model.method504(i1))
            flag = false;
        return flag;
    }
    ...
    public Model method228(int i, int j) {
        ...
        if (k == -1)
            return null;
        Model model = Model.method503(k, 6);
        if (l != -1)
            if (i1 != -1) {
                Model model_1 = Model.method503(l, 6);
                Model class44_sub3_sub4_sub4_3 = Model.method503(i1, 6);
                Model[] aclass44_sub3_sub4_sub4_1 = {
                        model, model_1, class44_sub3_sub4_sub4_3
                };
                model = new Model(3, -643, aclass44_sub3_sub4_sub4_1);
            } else {
                Model model_2 = Model.method503(l, 6);
                Model[] aclass44_sub3_sub4_sub4 = {
                        model, model_2
                };
                model = new Model(2, -643, aclass44_sub3_sub4_sub4);
            }
        if (j == 0 && aByte345 != 0)
            model.method516(0, aByte345, (byte) 10, 0);
        if (j == 1 && aByte348 != 0)
            model.method516(0, aByte348, (byte) 10, 0);
        if (anIntArray329 != null) {
            for (int j1 = 0; j1 < anIntArray329.length; j1++)
                model.method517(anIntArray329[j1], anIntArray330[j1]);
    ...
    public boolean method229(int i, byte byte0) {
        ...
        if (byte0 == 1)
            ...
            throw new NullPointerException();
        if (!Model.method504(j))
            flag = false;
        if (k != -1 && !Model.method504(k))
            flag = false;
        return flag;
    }

    public Model method230(boolean flag, int i) {
        int j = anInt351;
        int k = anInt352;
        if (flag)
            throw new NullPointerException();
        ...
        if (j == -1)
            return null;
        Model model = Model.method503(j, 6);
        if (k != -1) {
            Model model_1 = Model.method503(k, 6);
            Model[] aclass44_sub3_sub4_sub4 = {
                    model, model_1
            };
            model = new Model(2, -643, aclass44_sub3_sub4_sub4);
