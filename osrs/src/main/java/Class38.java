public class Class38 {
  ...
  public void method338(Buffer var1, byte var2, int var3) {
    ...
    while (true) {
      ...
      if (var4 == 1) {
        this.anInt664 = var1.readUByte();
      } else if (var4 == 2) {
        this.anInt665 = var1.readUByte();
      } else if (var4 == 3) {
        ...
        this.anInt668 = var1.readUShort();
      } else if (var4 == 6) {
        this.aBoolean669 = true;
      } else if (var4 == 7) {
        this.anInt670 = var1.readInt();
      } else if (var4 == 8) {
        this.anInt671 = 1;
        this.aBoolean672 = true;
      } else if (var4 == 10) {
        this.aString663 = var1.readString();
      } else if (var4 == 11) {
        this.aBoolean672 = true;
      } else if (var4 == 12) {
        this.anInt673 = var1.readInt();
      } else if (var4 == 13) {
        this.anInt671 = 2;
      } else {
  ...
  public static void method337(boolean var0, Class47 var1) {
    Buffer var2 = new Buffer(var1.method546("varp.dat", null), (byte) 1);
    anInt661 = 0;
    anInt659 = var2.readUShort();
