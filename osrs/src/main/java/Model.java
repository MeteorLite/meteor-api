public class Model extends Renderable {
  ...
  static {
    anIntArray1710 = Canvas.anIntArray1536;
    anIntArray1711 = Canvas.anIntArray1537;
    anIntArray1712 = Canvas.anIntArray1548;
    anIntArray1713 = Canvas.anIntArray1535;
  }
  ...
  public Model(int i, int j) {
    ...
    for (int j1 = 0; j1 < anInt1648; j1++) {
      ...
      if (anIntArray1676 != null) {
        anIntArray1676[j1] = class50_sub1_sub2_4.readUByte();
      }
    }

    class50_sub1_sub2.offset = class26.anInt544;
    class50_sub1_sub2_1.offset = class26.anInt545;
    class50_sub1_sub2_2.offset = class26.anInt546;
    class50_sub1_sub2_3.offset = class26.anInt547;
    class50_sub1_sub2_4.offset = class26.anInt548;
    for (int l1 = 0; l1 < anInt1652; l1++) {
      anIntArray1662[l1] = class50_sub1_sub2.readUShort();
      if (anIntArray1659 != null) {
        anIntArray1659[l1] = class50_sub1_sub2_1.readUByte();
      }
      if (anIntArray1660 != null) {
        anIntArray1660[l1] = class50_sub1_sub2_2.readUByte();
      }
      if (anIntArray1661 != null) {
        anIntArray1661[l1] = class50_sub1_sub2_3.readUByte();
      }
      if (anIntArray1677 != null) {
        anIntArray1677[l1] = class50_sub1_sub2_4.readUByte();
      }
    }

    class50_sub1_sub2.offset = class26.anInt542;
    class50_sub1_sub2_1.offset = class26.anInt543;
    int j2 = 0;
    int l2 = 0;
    int j3 = 0;
    int k3 = 0;
    for (int l3 = 0; l3 < anInt1652; l3++) {
      int i4 = class50_sub1_sub2_1.readUByte();
      if (i4 == 1) {
    ...
    class50_sub1_sub2.offset = class26.anInt549;
    for (int j4 = 0; j4 < anInt1664; j4++) {
      anIntArray1665[j4] = class50_sub1_sub2.readUShort();
      anIntArray1666[j4] = class50_sub1_sub2.readUShort();
      anIntArray1667[j4] = class50_sub1_sub2.readUShort();
    }
    ...
    for (int l = 0; l < i; l++) {
      ...
      if (class50_sub1_sub4_sub4_1 != null) {
        for (int i1 = 0; i1 < class50_sub1_sub4_sub4_1.anInt1652; i1++) {
          ...
          if (flag3
              && class50_sub1_sub4_sub4_1.anIntArray1677 != null) {
        ...
        for (int k1 = 0; k1 < class50_sub1_sub4_sub4_1.anInt1664; k1++) {
          anIntArray1665[anInt1664] = method580(
              class50_sub1_sub4_sub4_1,
              class50_sub1_sub4_sub4_1.anIntArray1665[k1]);
          anIntArray1666[anInt1664] = method580(
              class50_sub1_sub4_sub4_1,
              class50_sub1_sub4_sub4_1.anIntArray1666[k1]);
          anIntArray1667[anInt1664] = method580(
              class50_sub1_sub4_sub4_1,
    ...
    for (int i1 = 0; i1 < i; i1++) {
      ...
      if (class50_sub1_sub4_sub4_1 != null) {
        ...
        for (int l1 = 0; l1 < class50_sub1_sub4_sub4_1.anInt1652; l1++) {
          anIntArray1653[anInt1652] = class50_sub1_sub4_sub4_1.anIntArray1653[l1]
              + j1;
          anIntArray1654[anInt1652] = class50_sub1_sub4_sub4_1.anIntArray1654[l1]
              + j1;
          anIntArray1655[anInt1652] = class50_sub1_sub4_sub4_1.anIntArray1655[l1]
              + j1;
          ...
          if (flag4
              && class50_sub1_sub4_sub4_1.anIntArray1662 != null) {
        ...
        for (int j2 = 0; j2 < class50_sub1_sub4_sub4_1.anInt1664; j2++) {
          anIntArray1665[anInt1664] = class50_sub1_sub4_sub4_1.anIntArray1665[j2]
              + j1;
          anIntArray1666[anInt1664] = class50_sub1_sub4_sub4_1.anIntArray1666[j2]
              + j1;
          anIntArray1667[anInt1664] = class50_sub1_sub4_sub4_1.anIntArray1667[j2]
              + j1;
          anInt1664++;
        }
  ...
  public Model(boolean flag, boolean flag1, boolean flag2,
    ...
    if (flag2) {
      ...
      anIntArray1662 = new int[anInt1652];
      System.arraycopy(class50_sub1_sub4_sub4.anIntArray1662, 0, anIntArray1662, 0, anInt1652);
    ...
    if (flag3) {
      ...
      if (class50_sub1_sub4_sub4.anIntArray1661 == null) {
        ...
        System.arraycopy(class50_sub1_sub4_sub4.anIntArray1661, 0, anIntArray1661, 0, anInt1652);
  ...
  public Model(boolean flag, boolean flag1, int i,
    ...
    if (flag) {
      anIntArray1650 = new int[anInt1648];
      System.arraycopy(class50_sub1_sub4_sub4.anIntArray1650, 0, anIntArray1650, 0, anInt1648);
    ...
    if (flag1) {
      ...
      if (class50_sub1_sub4_sub4.anIntArray1659 == null) {
        ...
        System.arraycopy(class50_sub1_sub4_sub4.anIntArray1659, 0, anIntArray1659, 0, anInt1652);

      }
      super.aClass40Array1474 = new VertexNormal[anInt1648];
      for (int j1 = 0; j1 < anInt1648; j1++) {
        VertexNormal class40 = super.aClass40Array1474[j1] = new VertexNormal();
        VertexNormal class40_1 = class50_sub1_sub4_sub4.aClass40Array1474[j1];
    ...
    anIntArray1666 = class50_sub1_sub4_sub4.anIntArray1666;
    anIntArray1667 = class50_sub1_sub4_sub4.anIntArray1667;
    super.modelHeight = class50_sub1_sub4_sub4.modelHeight;
  ...
  public static void method575(byte[] abyte0, int i, byte byte0) {
    ...
    class50_sub1_sub2.offset = abyte0.length - 18;
    ModelHeader class26_1 = aClass26Array1682[i] = new ModelHeader();
    class26_1.aByteArray533 = abyte0;
    class26_1.anInt534 = class50_sub1_sub2.readUShort();
    class26_1.anInt535 = class50_sub1_sub2.readUShort();
    class26_1.anInt536 = class50_sub1_sub2.readUByte();
    ...
    int k1 = class50_sub1_sub2.readUShort();
    int l1 = class50_sub1_sub2.readUShort();
    int i2 = class50_sub1_sub2.readUShort();
    int j2 = class50_sub1_sub2.readUShort();
    int k2 = 0;
  ...
  public int method580(Model class50_sub1_sub4_sub4, int i) {
    ...
    for (int j1 = 0; j1 < anInt1648; j1++) {
      if (k != anIntArray1649[j1] || l != anIntArray1650[j1]
          || i1 != anIntArray1651[j1]) {
        continue;
      }
      j = j1;
  ...
  public void method581(int i) {
    ...
    anInt1674 = (int) (Math.sqrt(anInt1671 * anInt1671 + super.modelHeight
        * super.modelHeight) + 0.98999999999999999D);
    i = 64 / i;
    anInt1673 = anInt1674
        + (int) (Math.sqrt(anInt1671 * anInt1671 + anInt1672
        * anInt1672) + 0.98999999999999999D);
  }
  ...
  public void method583(int i) {
    ...
    anInt1673 = anInt1674
        + (int) Math
        .sqrt(anInt1671 * anInt1671 + anInt1672 * anInt1672);
  ...
  public void transform(int i) {
    ...
    Animation class21 = Animation.getAnimation(i);
    if (class21 == null) {
      return;
    }
    ...
    anInt1703 = 0;
    anInt1704 = 0;
    for (int j = 0; j < class21.stepCount; j++) {
      int k = class21.opcodeLinkTable[j];
      method587(class41.opcodes[k], class41.anIntArrayArray699[k],
          class21.anIntArray435[j], class21.anIntArray436[j],
          class21.anIntArray437[j]);
    }
  ...
  public void method586(int i, int j, int k, int[] ai) {
    ...
    Animation class21 = Animation.getAnimation(k);
    if (class21 == null) {
      return;
    }
    Animation class21_1 = Animation.getAnimation(i);
    if (class21_1 == null) {
      transform(k);
      return;
    }
    ...
    int l = 0;
    int i1 = ai[l++];
    for (int j1 = 0; j1 < class21.stepCount; j1++) {
      int k1;
      for (k1 = class21.opcodeLinkTable[j1]; k1 > i1; i1 = ai[l++]) {
      }
      if (k1 != i1 || class41.opcodes[k1] == 0) {
        method587(class41.opcodes[k1],
            class41.anIntArrayArray699[k1],
            class21.anIntArray435[j1], class21.anIntArray436[j1],
            class21.anIntArray437[j1]);
      }
    }
    ...
    l = 0;
    i1 = ai[l++];
    for (int l1 = 0; l1 < class21_1.stepCount; l1++) {
      int i2;
      for (i2 = class21_1.opcodeLinkTable[l1]; i2 > i1; i1 = ai[l++]) {
      }
      if (i2 == i1 || class41.opcodes[i2] == 0) {
        method587(class41.opcodes[i2],
            class41.anIntArrayArray699[i2],
            class21_1.anIntArray435[l1],
            class21_1.anIntArray436[l1],
            class21_1.anIntArray437[l1]);
      }
    }
        ...
        if (i3 < anIntArrayArray1678.length) {
          ...
          for (int element : ai2) {
            ...
            if (i7 != 0) {
              ...
              int l8 = anIntArray1650[k5] * j7
                  + anIntArray1649[k5] * i8 >> 16;
              anIntArray1650[k5] = anIntArray1650[k5] * i8
                  - anIntArray1649[k5] * j7 >> 16;
              anIntArray1649[k5] = l8;
            }
            if (k6 != 0) {
              int k7 = anIntArray1710[k6];
              int j8 = anIntArray1711[k6];
              int i9 = anIntArray1650[k5] * j8
                  - anIntArray1651[k5] * k7 >> 16;
              anIntArray1651[k5] = anIntArray1650[k5] * k7
                  + anIntArray1651[k5] * j8 >> 16;
              anIntArray1650[k5] = i9;
            }
            if (l6 != 0) {
              int l7 = anIntArray1710[l6];
              int k8 = anIntArray1711[l6];
              int j9 = anIntArray1651[k5] * l7
                  + anIntArray1649[k5] * k8 >> 16;
              anIntArray1651[k5] = anIntArray1651[k5] * k8
                  - anIntArray1649[k5] * l7 >> 16;
  ...
  public void method589(int i, int j) {
    ...
    for (int i1 = 0; i1 < anInt1648; i1++) {
      ...
      anIntArray1651[i1] = anIntArray1650[i1] * k + anIntArray1651[i1]
          * l >> 16;
  ...
  public void lighten(int i, int j, int k, int l, int i1, boolean flag) {
    ...
    for (int i2 = 0; i2 < anInt1652; i2++) {
      ...
      if (anIntArray1659 == null || (anIntArray1659[i2] & 1) == 0) {
        ...
        anIntArray1656[i2] = method597(anIntArray1662[i2], l5,
            anIntArray1659[i2]);
      }
    }
  ...
  public void method596(int i, int j, int k, int l, int i1) {
    for (int j1 = 0; j1 < anInt1652; j1++) {
      ...
      if (anIntArray1659 == null) {
        ...
        int k2 = i
            + (k * class40.anInt693 + l * class40.anInt694 + i1
            * class40.anInt695) / (j * class40.anInt696);
        ...
        int l2 = i
            + (k * class40_1.anInt693 + l * class40_1.anInt694 + i1
            * class40_1.anInt695)
  ...
  public void method598(int i, int j, int k, int l, int i1, int j1, int k1) {
    int l1 = Canvas.anInt1532;
    int i2 = Canvas.anInt1533;
  ...
  public void render(int i, int j, int k, int l, int i1, int j1, int k1,
    ...
    if (i2 > 0 && aBoolean1705) {
      ...
      int i6 = anInt1706 - Canvas.anInt1532;
      int k6 = anInt1707 - Canvas.anInt1533;
    ...
    int l5 = Canvas.anInt1532;
    int j6 = Canvas.anInt1533;
    int l6 = 0;
    int i7 = 0;
    if (i != 0) {
      l6 = anIntArray1710[i];
  ...
  public void method599(boolean flag, boolean flag1, int i) {
    ...
    for (int k = 0; k < anInt1652; k++) {
      if (anIntArray1659 == null || anIntArray1659[k] != -1) {
        ...
        if (flag && (i3 == -5000 || l3 == -5000 || k4 == -5000)) {
          ...
          int j5 = (anIntArray1688[l] + anIntArray1688[k1] + anIntArray1688[j2])
              / 3 + anInt1674;
          anIntArrayArray1693[j5][anIntArray1692[j5]++] = k;
        } else {
          if (flag1
              && method602(anInt1706, anInt1707,
              anIntArray1687[l], anIntArray1687[k1],
          ...
          if ((i3 - l3) * (anIntArray1687[j2] - anIntArray1687[k1])
            ...
            aBooleanArray1684[k] = i3 < 0 || l3 < 0 || k4 < 0
                || i3 > Rasterizer.anInt1431
                || l3 > Rasterizer.anInt1431
                || k4 > Rasterizer.anInt1431;
            int k5 = (anIntArray1688[l] + anIntArray1688[k1] + anIntArray1688[j2])
                / 3 + anInt1674;
    ...
    if (anIntArray1694[1] > 0 || anIntArray1694[2] > 0) {
      l2 = (anIntArray1698[1] + anIntArray1698[2])
          / (anIntArray1694[1] + anIntArray1694[2]);
    }
    int k3 = 0;
    if (anIntArray1694[3] > 0 || anIntArray1694[4] > 0) {
      k3 = (anIntArray1698[3] + anIntArray1698[4])
          / (anIntArray1694[3] + anIntArray1694[4]);
    }
    int j4 = 0;
    if (anIntArray1694[6] > 0 || anIntArray1694[8] > 0) {
      j4 = (anIntArray1698[6] + anIntArray1698[8])
          / (anIntArray1694[6] + anIntArray1694[8]);
    }
    int i6 = 0;
  ...
  public void method600(int i) {
    ...
    Canvas.aBoolean1528 = aBooleanArray1684[i];
    if (anIntArray1661 == null) {
      Canvas.anInt1531 = 0;
    } else {
      Canvas.anInt1531 = anIntArray1661[i];
    }
    int i1;
    if (anIntArray1659 == null) {
      i1 = 0;
    ...
    if (i1 == 0) {
      Canvas.method503(anIntArray1687[j],
          anIntArray1687[k], anIntArray1687[l], anIntArray1686[j],
          anIntArray1686[k], anIntArray1686[l], anIntArray1656[i],
          anIntArray1657[i], anIntArray1658[i]);
      return;
    }
    if (i1 == 1) {
      Canvas.method505(anIntArray1687[j],
          anIntArray1687[k], anIntArray1687[l], anIntArray1686[j],
          anIntArray1686[k], anIntArray1686[l],
          anIntArray1712[anIntArray1656[i]]);
      return;
    }
    if (i1 == 2) {
      ...
      Canvas.method507(anIntArray1687[j],
          anIntArray1687[k], anIntArray1687[l], anIntArray1686[j],
          anIntArray1686[k], anIntArray1686[l], anIntArray1656[i],
          anIntArray1657[i], anIntArray1658[i], anIntArray1689[l1],
          anIntArray1689[j2], anIntArray1689[l2], anIntArray1690[l1],
          anIntArray1690[j2], anIntArray1690[l2], anIntArray1691[l1],
          anIntArray1691[j2], anIntArray1691[l2], anIntArray1662[i]);
      return;
    }
    if (i1 == 3) {
      ...
      Canvas.method507(anIntArray1687[j],
          anIntArray1687[k], anIntArray1687[l], anIntArray1686[j],
          anIntArray1686[k], anIntArray1686[l], anIntArray1656[i],
          anIntArray1656[i], anIntArray1656[i], anIntArray1689[i2],
          anIntArray1689[k2], anIntArray1689[i3], anIntArray1690[i2],
          anIntArray1690[k2], anIntArray1690[i3], anIntArray1691[i2],
          anIntArray1691[k2], anIntArray1691[i3], anIntArray1662[i]);
    }
  }

  public void method601(int i) {
    int j = Canvas.anInt1532;
    int k = Canvas.anInt1533;
    int l = 0;
    ...
    if (l1 >= 50) {
      ...
      if (j2 >= 50) {
        ...
        anIntArray1699[l] = j
            + (k2 + ((anIntArray1689[k1] - k2) * k5 >> 16) << 9)
            / 50;
        anIntArray1700[l] = k
            + (k3 + ((anIntArray1690[k1] - k3) * k5 >> 16) << 9)
            / 50;
        anIntArray1701[l++] = k4
            + ((anIntArray1658[i] - k4) * k5 >> 16);
      }
      if (i2 >= 50) {
        int l5 = (50 - l1) * anIntArray1713[i2 - l1];
        anIntArray1699[l] = j
            + (k2 + ((anIntArray1689[j1] - k2) * l5 >> 16) << 9)
            / 50;
        anIntArray1700[l] = k
            + (k3 + ((anIntArray1690[j1] - k3) * l5 >> 16) << 9)
            / 50;
        anIntArray1701[l++] = k4
            + ((anIntArray1657[i] - k4) * l5 >> 16);
      }
    }
    if (i2 >= 50) {
      ...
      if (l1 >= 50) {
        ...
        anIntArray1699[l] = j
            + (l2 + ((anIntArray1689[i1] - l2) * i6 >> 16) << 9)
            / 50;
        anIntArray1700[l] = k
            + (l3 + ((anIntArray1690[i1] - l3) * i6 >> 16) << 9)
            / 50;
        anIntArray1701[l++] = l4
            + ((anIntArray1656[i] - l4) * i6 >> 16);
      }
      if (j2 >= 50) {
        int j6 = (50 - i2) * anIntArray1713[j2 - i2];
        anIntArray1699[l] = j
            + (l2 + ((anIntArray1689[k1] - l2) * j6 >> 16) << 9)
            / 50;
        anIntArray1700[l] = k
            + (l3 + ((anIntArray1690[k1] - l3) * j6 >> 16) << 9)
            / 50;
        anIntArray1701[l++] = l4
            + ((anIntArray1658[i] - l4) * j6 >> 16);
      }
    }
    if (j2 >= 50) {
      ...
      if (i2 >= 50) {
        ...
        anIntArray1699[l] = j
            + (i3 + ((anIntArray1689[j1] - i3) * k6 >> 16) << 9)
            / 50;
        anIntArray1700[l] = k
            + (i4 + ((anIntArray1690[j1] - i4) * k6 >> 16) << 9)
            / 50;
        anIntArray1701[l++] = i5
            + ((anIntArray1657[i] - i5) * k6 >> 16);
      }
      if (l1 >= 50) {
        int l6 = (50 - j2) * anIntArray1713[l1 - j2];
        anIntArray1699[l] = j
            + (i3 + ((anIntArray1689[i1] - i3) * l6 >> 16) << 9)
            / 50;
        anIntArray1700[l] = k
            + (i4 + ((anIntArray1690[i1] - i4) * l6 >> 16) << 9)
            / 50;
        anIntArray1701[l++] = i5
            + ((anIntArray1656[i] - i5) * l6 >> 16);
      }
    }
    ...
    if ((j3 - j4) * (k7 - j7) - (i7 - j7) * (j5 - j4) > 0) {
      Canvas.aBoolean1528 = false;
      if (l == 3) {
        if (j3 < 0 || j4 < 0 || j5 < 0
            || j3 > Rasterizer.anInt1431
            || j4 > Rasterizer.anInt1431
            || j5 > Rasterizer.anInt1431) {
          Canvas.aBoolean1528 = true;
        }
        int l7;
        if (anIntArray1659 == null) {
          l7 = 0;
        ...
        if (l7 == 0) {
          Canvas.method503(i7, j7, k7, j3, j4, j5,
              anIntArray1701[0], anIntArray1701[1],
              anIntArray1701[2]);
        } else if (l7 == 1) {
          Canvas.method505(i7, j7, k7, j3, j4, j5,
              anIntArray1712[anIntArray1656[i]]);
        } else if (l7 == 2) {
          ...
          Canvas.method507(i7, j7, k7, j3, j4, j5,
              anIntArray1701[0], anIntArray1701[1],
              anIntArray1701[2], anIntArray1689[k9],
              anIntArray1689[k10], anIntArray1689[k11],
              anIntArray1690[k9], anIntArray1690[k10],
              anIntArray1690[k11], anIntArray1691[k9],
              anIntArray1691[k10], anIntArray1691[k11],
              anIntArray1662[i]);
        } else if (l7 == 3) {
          ...
          Canvas.method507(i7, j7, k7, j3, j4, j5,
              ...
              anIntArray1656[i], anIntArray1689[l9],
              anIntArray1689[l10], anIntArray1689[l11],
              anIntArray1690[l9], anIntArray1690[l10],
              anIntArray1690[l11], anIntArray1691[l9],
              anIntArray1691[l10], anIntArray1691[l11],
              anIntArray1662[i]);
        }
      }
      if (l == 4) {
        if (j3 < 0 || j4 < 0 || j5 < 0
            ...
            || j5 > Rasterizer.anInt1431
            || anIntArray1699[3] < 0
            || anIntArray1699[3] > Rasterizer.anInt1431) {
          Canvas.aBoolean1528 = true;
        }
        int i8;
        if (anIntArray1659 == null) {
        ...
        if (i8 == 0) {
          Canvas.method503(i7, j7, k7, j3, j4, j5,
              anIntArray1701[0], anIntArray1701[1],
              anIntArray1701[2]);
          Canvas.method503(i7, k7, anIntArray1700[3],
              j3, j5, anIntArray1699[3], anIntArray1701[0],
              anIntArray1701[2], anIntArray1701[3]);
          return;
        }
        if (i8 == 1) {
          int l8 = anIntArray1712[anIntArray1656[i]];
          Canvas
              .method505(i7, j7, k7, j3, j4, j5, l8);
          Canvas.method505(i7, k7, anIntArray1700[3],
              j3, j5, anIntArray1699[3], l8);
          return;
        }
        if (i8 == 2) {
          ...
          Canvas.method507(i7, j7, k7, j3, j4, j5,
              anIntArray1701[0], anIntArray1701[1],
              anIntArray1701[2], anIntArray1689[i10],
              anIntArray1689[i11], anIntArray1689[i12],
              anIntArray1690[i10], anIntArray1690[i11],
              anIntArray1690[i12], anIntArray1691[i10],
              anIntArray1691[i11], anIntArray1691[i12],
              anIntArray1662[i]);
          Canvas.method507(i7, k7, anIntArray1700[3],
              j3, j5, anIntArray1699[3], anIntArray1701[0],
              anIntArray1701[2], anIntArray1701[3],
              anIntArray1689[i10], anIntArray1689[i11],
              anIntArray1689[i12], anIntArray1690[i10],
              anIntArray1690[i11], anIntArray1690[i12],
              anIntArray1691[i10], anIntArray1691[i11],
              anIntArray1691[i12], anIntArray1662[i]);
          return;
        }
        if (i8 == 3) {
          ...
          Canvas.method507(i7, j7, k7, j3, j4, j5,
              anIntArray1656[i], anIntArray1656[i],
              anIntArray1656[i], anIntArray1689[j10],
              anIntArray1689[j11], anIntArray1689[j12],
              anIntArray1690[j10], anIntArray1690[j11],
              anIntArray1690[j12], anIntArray1691[j10],
              anIntArray1691[j11], anIntArray1691[j12],
              anIntArray1662[i]);
          Canvas.method507(i7, k7, anIntArray1700[3],
              j3, j5, anIntArray1699[3], anIntArray1656[i],
              anIntArray1656[i], anIntArray1656[i],
              anIntArray1689[j10], anIntArray1689[j11],
              anIntArray1689[j12], anIntArray1690[j10],
              anIntArray1690[j11], anIntArray1690[j12],
              anIntArray1691[j10], anIntArray1691[j11],
              anIntArray1691[j12], anIntArray1662[i]);
        }
      }
    }
  }

  public boolean method602(int i, int j, int k, int l, int i1, int j1,
      int k1, int l1) {
    if (j < k && j < l && j < i1) {
      return false;
    }
